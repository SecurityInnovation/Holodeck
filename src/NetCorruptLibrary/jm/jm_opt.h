...
/* JM                    Defines the namespace used for this library,
                           defaults to "jm", but can be changed by defining
                           JM on the command line. */
/* #define JM */

/* JM_STD               Defines the namespace used by the underlying STL
                          (if any), defaults to "std", can be changed by
                          defining JM_STD on the command line. */
/* #define JM_STD */


/* JM_STDC              Defines the namespace used by the C Library defs.
                          Defaults to "std" as recomended by the latest
                          draft standard, can be redefined by defining
                          JM_STDC on the command line. */
/* #define JM_STDC */
...
/* JM_NO_TEMPLATE_TYPENAME   If class scope typedefs of the form:
                             typedef typename X<T>::type Y;
                      where T is a template parameter to this,
                      do not compile unless the typename is omitted. */
/* #define JM_NO_TEMPLATE_TYPENAME */

/* JM_NO_DEFAULT_PARAMS_IN_TEMPLATES   If template functions can not have non-template
                                       parameters with default values (AIX compiler bug) */
/* #define JM_NO_DEFAULT_PARAMS_IN_TEMPLATES */
...
/* JM_ITERATOR_T             Defines generic standard iterator type if available, use this as
                             ...
                             1 = JM_STD::iterator<JM_STD::tag_type, T, D, T*, T&>
                      2 = JM_STD::iterator<JM_STD::tag_type, T, D> */
/* #define JM_ITERATOR_T */

/* JM_OI_T                   For output iterators:
                             0 = NA
                      1 = JM_STD::iterator<JM_STD::output_iterator_tag, T, D, T*, T&>
                      2 = JM_STD::iterator<JM_STD::output_iterator_tag, T, D>
                      3 = JM_STD::output_iterator */
/* #define JM_OI_T */

/* JM_II_T                   For input iterators:
                             0 = NA
                      1 = JM_STD::iterator<JM_STD::input_iterator_tag, T, D, T*, T&>
                      2 = JM_STD::iterator<JM_STD::input_iterator_tag, T, D>
                      3 = JM_STD::input_iterator<T, D>
                      4 = JM_STD::input_iterator<T> */
/* #define JM_II_T */

/* JM_FI_T                   For forward iterators:
                             0 = NA
                      1 = JM_STD::iterator<JM_STD::forward_iterator_tag, T, D, T*, T&>
                      2 = JM_STD::iterator<JM_STD::forward_iterator_tag, T, D>
                      3 = JM_STD::forward_iterator<T, D> */
/* #define JM_FI_T */

/* JM_BI_T                   For bidirectional iterators:
                             0 = NA
                      1 = JM_STD::iterator<JM_STD::bidirectional_iterator_tag, T, D, T*, T&>
                      2 = JM_STD::iterator<JM_STD::bidirectional_iterator_tag, T, D>
                      3 = JM_STD::bidirectional_iterator<T, D> */
/* #define JM_BI_T */

/* JM_RI_T                   For random access iterators:
                             0 = NA
                             1 = JM_STD::iterator<JM_STD::random_access_iterator_tag, T, D, T*, T&>
                      2 = JM_STD::iterator<JM_STD::random_access_iterator_tag, T, D>
                      3 = JM_STD::random_access_iterator<T, D> */
/* #define JM_RI_T */
...
#if JM_DISTANCE_T == 0
#  define JM_DISTANCE(i, j, n) n = (int)(j - i)
#elif JM_DISTANCE_T == 1
#  define JM_DISTANCE(i, j, n) n = (int)JM_STD::distance(i, j)
#elif JM_DISTANCE_T == 2
#  define JM_DISTANCE(i, j, n) (n = 0, JM_STD::distance(i, j, n))
#else
syntax erorr
#endif
...
#if defined(JM_NO_MEMORY_H) || defined(__GNUC__)
