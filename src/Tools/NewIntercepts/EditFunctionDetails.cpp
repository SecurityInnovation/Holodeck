...
namespace AddNewIntercepts
{
	...
	EditFunctionDetails::EditFunctionDetails()
	{
		...
		txtEditor->KeyPress += new System::Windows::Forms::KeyPressEventHandler(this, txtEditor_KeyPress);
		txtEditor->LostFocus += new System::EventHandler(this, txtEditor_LostFocus);
		lvParams->MouseDown += new MouseEventHandler (this, lvParams_MouseDown);
		lvParams->DoubleClick += new EventHandler (this, lvParams_MouseDoubleClick);
		this->subItemSelected = 0;

		//Add events to update function definition textbox
		this->cmbReturnType->TextChanged += new EventHandler (this, definitionChanged_Handler);
		this->txtTypeMods->TextChanged += new EventHandler (this, definitionChanged_Handler);
		this->txtCCMods->TextChanged += new EventHandler (this, definitionChanged_Handler);
