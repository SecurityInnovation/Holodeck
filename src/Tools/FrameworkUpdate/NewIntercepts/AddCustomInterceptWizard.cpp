...
namespace AddNewIntercepts
{
	...
	AddCustomInterceptWizard::AddCustomInterceptWizard() : Form()
	{
		...
		wizardControl->WizardPageEnter += new Crownwood::Magic::Controls::WizardControl::WizardPageHandler(this, &AddNewIntercepts::AddCustomInterceptWizard::onControlPageEnter);
		wizardControl->WizardPageLeave += new Crownwood::Magic::Controls::WizardControl::WizardPageHandler(this, &AddNewIntercepts::AddCustomInterceptWizard::onControlPageLeave);
		EventHandler *cancelHandler = new EventHandler(this, &AddNewIntercepts::AddCustomInterceptWizard::onCancelClicked);
		wizardControl->CancelClick += cancelHandler;
		wizardControl->CloseClick += cancelHandler;
		wizardControl->FinishClick += new EventHandler(this, &AddNewIntercepts::AddCustomInterceptWizard::onFinishClicked);
