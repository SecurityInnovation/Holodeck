...
//
// FILE:		CorruptionSearchSelectionPage.cpp
//
// DESCRIPTION: Contains implementation for the class CorruptionSearchSelectionPage
//
//=========================================================================
...
//*************************************************************************
#include <windows.h>
#include "CorruptionSearchSelectionPage.h"
#include "defines.h"
...
{
	//*************************************************************************
	// Method:		CorruptionSearchSelectionPage
	// Description: Constructor for the CorruptionSearchSelectionPage class
	//
	// Parameters:
	//	None
	//
	// Return Value: None
	//*************************************************************************
	CorruptionSearchSelectionPage::CorruptionSearchSelectionPage() : WizardPage()
	{
		this->Dock = DockStyle::Fill;
		this->SubTitle = "Select options for Find and Replace Fuzzing";
		...
		overwrite->Text = "If the replacement string is longer than the string "
			"to find, overwrite bytes following the string to find (leaves "
			"data the same length as the original)";
		overwrite->Location = System::Drawing::Point(8, 207);
		overwrite->Size = System::Drawing::Size(396, 48);
		...
		this->Controls->Add(overwrite);
	}

	//*************************************************************************
	// Method:		~CorruptionSearchSelectionPage
	// Description: Destructor for the CorruptionSearchSelectionPage class
	//
	// Parameters:
	//	None
	//
	// Return Value: None
	//*************************************************************************
	CorruptionSearchSelectionPage::~CorruptionSearchSelectionPage()
	{
	}
	...
	// Return Value: None
	//*************************************************************************
	void CorruptionSearchSelectionPage::onReplaceWithAnotherCheck(Object *sender, EventArgs *e)
	{
	...
	// Return Value: None
	//*************************************************************************
	void CorruptionSearchSelectionPage::onLongStringsCheck(Object *sender, EventArgs *e)
	{
	...
	// Return Value: None
	//*************************************************************************
	void CorruptionSearchSelectionPage::onRepeatedSeqCheck(Object *sender, EventArgs *e)
	{
	...
	//*************************************************************************
	String* CorruptionSearchSelectionPage::get_SearchFor()
	{
	...
	//*************************************************************************
	String* CorruptionSearchSelectionPage::get_SearchRegularExpression()
	{
		...
		if (overwrite->Checked)
			return String::Concat("os/", escapedSearchStr, "/");
		else
	...
	// Return Value: String representing corruption settings
	//*************************************************************************
	String* CorruptionSearchSelectionPage::get_ReplaceWith()
	{
		if (overwrite->Checked)
		{
			if (replaceWithAnother->Checked)
				return String::Concat(S"Overwrite using ", replaceStringType->Text, S" \"", replaceString->Text, S"\"");
			if (longStrings->Checked)
				return String::Concat(S"Overwrite using long string, up to ", longStringMaxLen->Text, S" bytes");
			return String::Concat(S"Overwrite using sequence, up to ", seqMaxLen->Text, S" of ", seqStringType->Text,
				S" \"", seqString->Text, S"\"");
		}
		else
		{
			if (replaceWithAnother->Checked)
				return String::Concat(S"Replace with ", replaceStringType->Text, S" \"", replaceString->Text, S"\"");
			if (longStrings->Checked)
				return String::Concat(S"Replace with long string, up to ", longStringMaxLen->Text, S" bytes");
			return String::Concat(S"Replace with sequence, up to ", seqMaxLen->Text, S" of ", seqStringType->Text,
				S" \"", seqString->Text, S"\"");
		}
	}
	...
	// Return Value: String representing corruption settings
	//*************************************************************************
	String* CorruptionSearchSelectionPage::get_ReplacementString()
	{
		if (replaceWithAnother->Checked)
		{
	...
	//*************************************************************************
	bool CorruptionSearchSelectionPage::Validate()
	{
		if (replaceWithAnother->Checked)
		{
	...
	//*************************************************************************
	bool CorruptionSearchSelectionPage::get_Overwrite()
	{
	...
	//*************************************************************************
	CorruptionSearchSettings CorruptionSearchSelectionPage::get_Settings()
	{
		CorruptionSearchSettings settings;
	...
	// Return Value: None
	//*************************************************************************
	void CorruptionSearchSelectionPage::set_Settings(CorruptionSearchSettings settings)
	{
