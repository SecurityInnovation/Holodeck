...
namespace HoloScript
{
	...
	public:
		...
		__property SiUtils::Mutex* get_LogEventMutex() { return logEventMutex; }
		...
		void CreateLogFile(String *fileName, String *pidString);

		void ExportToDiffFile(String *diffFileName, ArrayList *filePositionsToLog);
		bool OpenLogFile(String *newLogFileName);

		void ExportToDiffFileV2_1(String *diffFileName, ArrayList *filePositionsToLog);
		void ExportToDiffFileV2_5(String *diffFileName, ArrayList *filePositionsToLog);

		bool OpenLogFileV2_1(String *newLogFileName);
		bool OpenLogFileV2_5(String *newLogFileName);
	protected:
		SiUtils::Mutex *logFileMutex;		// guards the log file from multiple accesses
		SiUtils::Mutex *logEventMutex;		// guards the logs generated event
		...
		String * getFormattedString(String *str, int minLength);
	};
}