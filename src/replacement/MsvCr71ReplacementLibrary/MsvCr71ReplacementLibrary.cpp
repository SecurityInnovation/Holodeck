...
//
// FILE:		MsvCr71ReplacementLibrary.cpp
//
// DESCRIPTION: Contains replacement library functions for msvcr71.dll
//
//=========================================================================
...
//*************************************************************************
#include "msvcr71replacementlibrary.h"
...
void ReplacementLibraryAttach()
{
	...
	if (library == NULL)
	{
		library = new ReplacementLibrary("msvcr71.dll");
