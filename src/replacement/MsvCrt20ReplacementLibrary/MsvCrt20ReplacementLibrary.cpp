...
//
// FILE:		MsvCrt20ReplacementLibrary.cpp
//
// DESCRIPTION: Contains replacement library functions for msvcrt20.dll
//
//=========================================================================
...
// -----------  ---  ----------- ------------------------------------------
// Generated 05/07/2004 04:18:56 PM
//*************************************************************************
#include "msvcrt20replacementlibrary.h"
...
void ReplacementLibraryAttach()
{
	...
	if (library == NULL)
	{
		library = new ReplacementLibrary("msvcrt20.dll");
