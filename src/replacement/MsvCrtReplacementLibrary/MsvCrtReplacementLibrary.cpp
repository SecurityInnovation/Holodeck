...
//
// FILE:		MsvCrtReplacementLibrary.cpp
//
// DESCRIPTION: Contains replacement library functions for msvcrt.dll
//
//=========================================================================
...
// -----------  ---  ----------- ------------------------------------------
// Generated 05/07/2004 04:18:55 PM
//*************************************************************************
#include "msvcrtreplacementlibrary.h"
...
void ReplacementLibraryAttach()
{
	...
	if (library == NULL)
	{
		library = new ReplacementLibrary("msvcrt.dll");
