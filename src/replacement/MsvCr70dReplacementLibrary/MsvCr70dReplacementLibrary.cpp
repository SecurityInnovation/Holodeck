...
//
// FILE:		MsvCr70dReplacementLibrary.cpp
//
// DESCRIPTION: Contains replacement library functions for msvcr70d.dll
//
//=========================================================================
...
// -----------  ---  ----------- ------------------------------------------
// Generated 05/07/2004 04:18:59 PM
//*************************************************************************
#include "msvcr70dreplacementlibrary.h"
...
void ReplacementLibraryAttach()
{
	...
	if (library == NULL)
	{
		library = new ReplacementLibrary("msvcr70d.dll");
