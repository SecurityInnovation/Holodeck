...
//
// FILE:		MsvCr71dReplacementLibrary.cpp
//
// DESCRIPTION: Contains replacement library functions for msvcr71d.dll
//
//=========================================================================
...
// -----------  ---  ----------- ------------------------------------------
// Generated 05/07/2004 04:19:00 PM
//*************************************************************************
#include "msvcr71dreplacementlibrary.h"
...
void ReplacementLibraryAttach()
{
	...
	if (library == NULL)
	{
		library = new ReplacementLibrary("msvcr71d.dll");
