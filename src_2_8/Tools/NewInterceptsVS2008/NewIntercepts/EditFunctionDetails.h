...
namespace AddNewIntercepts
{
	...
	private:
		...
		void InitializeComponent(void)
		{
			...
			this->btnParamDel->Click += new System::EventHandler(this, &AddNewIntercepts::EditFunctionDetails::btnParamDel_Click);
			// 
			// btnParamAdd
			// 
			...
			this->btnParamAdd->Click += new System::EventHandler(this, &AddNewIntercepts::EditFunctionDetails::btnParamAdd_Click);
			// 
			// lvParams
			// 
