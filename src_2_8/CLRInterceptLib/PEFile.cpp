...
int  PEFile::getDotNetVersion()
{
	if (!m_fManaged)
		return 0;

	// Yes, this does 'INTEND' to return .NET version 1 in case the minor version is under 5
	return m_pchManagedHeader->MinorRuntimeVersion >= 5 ? 2 : 1;
}
