...
public:
   ...
   _priv_match_data(const reg_match_base<iterator, Allocator>&);
...
template <class iterator, class Allocator>
_priv_match_data<iterator, Allocator>::_priv_match_data(const reg_match_base<iterator, Allocator>& m)
...
//
#ifndef JM_NO_DEFAULT_PARAMS_IN_TEMPLATES
...
#else
template <class iterator, class Allocator, class charT, class traits, class Allocator2>
bool query_match(iterator first, iterator last, reg_match<iterator, Allocator>& m, const reg_expression<charT, traits, Allocator2>& e, unsigned flags)
#endif
{
   ...
   _priv_match_data<iterator, Allocator> pd(m);
   iterator restart;
...
inline bool query_match(const JM_STD::basic_string<charT, ST, SA>& s, 
                 reg_match<typename JM_STD::basic_string<charT, ST, SA>::const_iterator, Allocator>& m, 
                 const reg_expression<charT, traits, Allocator2>& e, 
                 unsigned flags = match_default)
{
...
#endif
#ifndef JM_NO_STRING_H
inline bool query_match(const JM_STD::string& s, 
                        reg_match<JM_STD::string::const_iterator, regex::alloc_type>& m, 
                        const regex& e, 
                        unsigned flags = match_default)
{
   return query_match(s.begin(), s.end(), m, e, flags);
...
inline bool query_match(const JM_STD::basic_string<wchar_t>& s, 
                        reg_match<JM_STD::basic_string<wchar_t>::const_iterator, wregex::alloc_type>& m, 
                        const wregex& e, 
                        unsigned flags = match_default)
{
   return query_match(s.begin(), s.end(), m, e, flags);
                     ...
                     iterator* restart)
{
   ...
   #ifdef RE_LOCALE_CPP
   const JM_STD::locale& locale_inst = e.locale();
   #endif
   ...
   *restart = first;
   ...
   while(first != last)
   {
      ...
      case syntax_element_set:
         ...
         if(((re_set*)ptr)->_map[(traits_uchar_type)traits::translate(*first, icase MAYBE_PASS_LOCALE(locale_inst))])
         {
            ptr = ptr->next.p;
            ++first;
            continue;
      ...
      {
         // alt_jump:
         if(reg_expression<charT, traits, Allocator2>::can_start(*first, ((re_jump*)ptr)->_map, (unsigned char)mask_take, width_type()))
         {
            // we can take the first alternative,
            // see if we need to push next alternative:
            if(reg_expression<charT, traits, Allocator2>::can_start(*first, ((re_jump*)ptr)->_map, mask_skip, width_type()))
            {
               if(need_push_match)
      ...
      case syntax_element_rep:
      {
         ...
         if(((re_repeat*)ptr)->alt.p->type == syntax_element_match)
         {
            ...
            if(((unsigned int)accumulators[cur_acc] < ((re_repeat*)ptr)->max)
                  && reg_expression<charT, traits, Allocator2>::can_start(*first, ((re_repeat*)ptr)->_map, mask_take, width_type()))
            {
            ...
            if(((unsigned int)accumulators[cur_acc] >= ((re_repeat*)ptr)->min)
               && reg_expression<charT, traits, Allocator2>::can_start(*first, ((re_repeat*)ptr)->_map, mask_skip, width_type()))
            {
...
struct grep_search_predicate
{
   ...
   {
      *pm = ((const reg_match_base<iterator, Allocator>&)(m));
      return false;
   }
};
...
unsigned int reg_grep2(Predicate foo, I first, I last, const reg_expression<charT, traits, A>& e, unsigned flags, A2 a)
{
   ...
   const unsigned char* _map = e.get_map();
   unsigned int type;
   ...
   if( reg_expression<charT, traits, A>::can_start(*first, _map, (unsigned char)mask_any, width_type() ) )
   {
      if(query_match_aux(first, last, m, e, flags, pd, &restart))
      {
         ++cmatches;
   ...
   case regbase::restart_fixed_lit:
   {
      ...
      while (first != last) 
      {
         ...
         if(j >= len) 
         {
            ...
            {
               _skip_and_dec(clines, last_line, first, base, (unsigned)j);
               restart = first;
               restart += len;
               m.set_first(first);
...
#else
template <class iterator, class Allocator, class charT, class traits, class Allocator2>
bool reg_search(iterator first, iterator last, reg_match<iterator, Allocator>& m, const reg_expression<charT, traits, Allocator2>& e, unsigned flags)
#endif
{
   if(e.flags() & regbase::failbit)
      return false;
...
#ifndef JM_NO_STRING_H
template <class ST, class SA, class Allocator, class charT, class traits, class Allocator2>
inline bool reg_search(const JM_STD::basic_string<charT, ST, SA>& s, 
                 reg_match<typename JM_STD::basic_string<charT, ST, SA>::const_iterator, Allocator>& m, 
                 const reg_expression<charT, traits, Allocator2>& e, 
                 unsigned flags = match_default)
{
...
#endif
#ifndef JM_NO_STRING_H
inline bool reg_search(const JM_STD::string& s, 
                        reg_match<JM_STD::string::const_iterator, regex::alloc_type>& m, 
                        const regex& e, 
                        unsigned flags = match_default)
{
...
#if !defined(JM_NO_STRING_DEF_ARGS) && !defined(JM_NO_WCSTRING)
inline bool reg_search(const JM_STD::basic_string<wchar_t>& s, 
                        reg_match<JM_STD::basic_string<wchar_t>::const_iterator, wregex::alloc_type>& m, 
                        const wregex& e, 
                        unsigned flags = match_default)
{
...
#else
template <class Predicate, class iterator, class charT, class traits, class Allocator>
inline unsigned int reg_grep(Predicate foo, iterator first, iterator last, const reg_expression<charT, traits, Allocator>& e, unsigned flags)
#endif
{
...
inline unsigned int reg_grep(Predicate foo, const JM_STD::basic_string<charT, ST, SA>& s, 
                 const reg_expression<charT, traits, Allocator>& e, 
                 unsigned flags = match_default)
{
...
#endif
#ifndef JM_NO_STRING_H
inline unsigned int reg_grep(bool (*foo)(const reg_match<JM_STD::string::const_iterator, regex::alloc_type>&), const JM_STD::string& s, 
                        const regex& e, 
                        unsigned flags = match_default)
{
   return reg_grep(foo, s.begin(), s.end(), e, flags);
...
#if !defined(JM_NO_STRING_DEF_ARGS) && !defined(JM_NO_WCSTRING)
inline unsigned int reg_grep(bool (*foo)(const reg_match<JM_STD::basic_string<wchar_t>::const_iterator, wregex::alloc_type>&), 
                     const JM_STD::basic_string<wchar_t>& s, 
                        const wregex& e, 
                        unsigned flags = match_default)
{
   return reg_grep(foo, s.begin(), s.end(), e, flags);
...
#else
template <class Out, class iterator, class charT, class traits, class Allocator>
inline unsigned int reg_grep_old(Out oi, iterator first, iterator last, const reg_expression<charT, traits, Allocator>& e, unsigned flags)
#endif
{
