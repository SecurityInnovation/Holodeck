...
namespace Crownwood.Magic.Menus
{
    ...
    public class PopupMenu : NativeWindow
    {
        ...
        public MenuCommand TrackPopup(Point screenPos, bool ignoreWindowHandle)
        {
            return TrackPopup(screenPos, false, ignoreWindowHandle);
        }

        public MenuCommand TrackPopup(Point screenPos, bool selectFirst, bool ignoreWindowHandle)
        {
            ...
            if (_menuCommands.VisibleItems())
            {
                ...
                return InternalTrackPopup(selectFirst, ignoreWindowHandle);
            }
                                        ...
                                        ref int returnDir)
        {
            ...
            MenuCommand ret = InternalTrackPopup(selectFirst, false);
        ...
        protected MenuCommand InternalTrackPopup(bool selectFirst, bool ignoreWindowHandle)
        {
			try
			{
	...
	//						Console.WriteLine("Track {0} {1}", this.Handle, ((Win32.Msgs)msg.message).ToString());
								...
								(msg.message == (int)Win32.Msgs.WM_NCXBUTTONUP))
							{
								...
								if ( (ignoreWindowHandle || (this.Handle == msg.hwnd)) && (screenPos.x >= _currentPoint.X) && (screenPos.x <= (_currentPoint.X + localWidth)) &&
