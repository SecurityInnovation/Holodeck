...
{
	/// <summary>
	/// Summary description for FunctionXMLTest38
	/// Make Functions.xml with Function Param Index Edited to IndexTestName
	/// </summary>
	public class FunctionXMLTest38:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest38()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case:Make Functions.xml with Function Param Index Edited to TypeTestName");
			try
			{
				string holodeckPath;
				...
				EditValues editIndex = new EditValues();
				editIndex.EditParam(nodeFunction,testValue,"Index");
