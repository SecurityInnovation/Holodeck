...
{
	/// <summary>
	/// Summary description for FunctionXMLTest33
	/// Make Functions.xml with Function ErrorCode IdentifyBy missing
	/// </summary>
	public class FunctionXMLTest33:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest33()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case:Make Functions.xml with Function ErrorCode IdentifyBy missing");
			try
			{
				string holodeckPath;
				...
				XmlNode nodeFunction = xmlDocument.SelectSingleNode( "/Functions/Function/ErrorCode[@IdentifyBy]" );

				nodeFunction.Attributes.RemoveNamedItem("IdentifyBy");
