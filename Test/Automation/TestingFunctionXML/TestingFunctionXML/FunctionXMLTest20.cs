...
{
	/// <summary>
	/// Summary description for FunctionXMLTest20
	/// Make Functions.xml with Function Modifier Value Edited to ModifierTestName
	/// </summary>
	public class FunctionXMLTest20:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest20()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case:Make Functions.xml with Function Modifier Value Edited to ModifierTestName");
			try
			{
				string holodeckPath;
				...
				EditValues editModifier = new EditValues();
				editModifier.EditFunction(nodeFunction,testValue,"Modifier");
