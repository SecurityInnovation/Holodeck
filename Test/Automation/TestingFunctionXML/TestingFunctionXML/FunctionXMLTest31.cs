...
{
	/// <summary>
	/// Summary description for FunctionXMLTest31
	/// Make Functions.xml with Function ErrorCode NodeValue missing
	/// </summary>
	public class FunctionXMLTest31:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest31()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case:Make Functions.xml with Function ErrorCode NodeValue missing");
			try
			{
				string holodeckPath;
