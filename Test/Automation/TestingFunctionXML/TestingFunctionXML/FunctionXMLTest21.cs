...
{
	/// <summary>
	/// Summary description for FunctionXMLTest21
	/// Make Functions.xml with Function Modifier missing
	/// </summary>
	public class FunctionXMLTest21:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest21()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case: Make Functions.xml with Function Modifier missing");
			try
			{
				string holodeckPath;
				...
				XmlNode nodeFunction = xmlDocument.SelectSingleNode( "/Functions/Function [last()]/Modifier" );
