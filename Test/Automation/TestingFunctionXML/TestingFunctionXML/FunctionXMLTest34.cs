...
{
	/// <summary>
	/// Summary description for FunctionXMLTest34
	/// Make Functions.xml with Function ErrorCode Type Edited to TypeTestName
	/// </summary>
	public class FunctionXMLTest34:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest34()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case:Make Functions.xml with Function ErrorCode Type Edited to TypeTestName");
			try
			{
				string holodeckPath;
				...
				editType.EditErrorCode(nodeFunction,testValue,"Type");
