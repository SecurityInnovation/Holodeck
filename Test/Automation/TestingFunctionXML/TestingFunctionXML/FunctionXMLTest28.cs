...
{
	/// <summary>
	/// Summary description for FunctionXMLTest28
	/// Make Functions.xml with Function ReturnValue Type Edited to TypeTestName
	/// </summary>
	public class FunctionXMLTest28:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest28()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case:Make Functions.xml with Function ReturnValue Type Edited to TypeTestName");
			try
			{
				string holodeckPath;
				...
				XmlNode nodeFunction = xmlDocument.SelectSingleNode( "/Functions/Function [last()]/ReturnValue" );
				
				EditValues editType = new EditValues();
				editType.EditReturnValue(nodeFunction,testValue,"Type");
				...
				catch(Holodeck.HolodeckExceptions.CannotStartHolodeckException ex)
				{
					...
					Console.WriteLine("This is because the testValue inserted in the original value is not enumuration list");
