...
{
	/// <summary>
	/// Summary description for FunctionXMLTest12
	/// Make Functions.xml with Function OriginalDll Value Edited to OriginalDllTestName
	/// </summary>
	public class FunctionXMLTest12:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest12()
		{
