...
{
	/// <summary>
	/// Summary description for FunctionXMLTest30
	/// Make Functions.xml with Function ErrorCode NodeValue Edited to NodeValueTestName
	/// </summary>
	public class FunctionXMLTest30:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest30()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case:Make Functions.xml with Function ErrorCode NodeValue Edited to NodeValueTestName");
			try
			{
				string holodeckPath;
				...
				editNodeValue.EditErrorCode(nodeFunction,testValue,"NodeValue");
