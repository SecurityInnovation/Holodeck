...
{
	/// <summary>
	/// Summary description for FunctionXMLTest36
	/// Make Functions.xml with Function Param Type Edited to TypeTestName
	/// </summary>
	public class FunctionXMLTest36:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest36()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case:Make Functions.xml with Function Param Type Edited to TypeTestName");
			try
			{
				string holodeckPath;
				...
				editType.EditParam(nodeFunction,testValue,"Type");
