...
{
	/// <summary>
	/// Summary description for FunctionXMLTest44
	/// Make Functions.xml with Function Param NodeValue Edited to NodeValueTestName
	/// </summary>
	public class FunctionXMLTest44:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest44()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case:Make Functions.xml with Function Param NodeValue Edited to NodeValueTestName");
			try
			{
				string holodeckPath;
