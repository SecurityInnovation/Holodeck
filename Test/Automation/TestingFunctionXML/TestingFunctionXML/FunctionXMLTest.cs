...
namespace FunctionXMLTest
{
    ...
    /// </summary>
    public class FunctionXMLTest : RunTest
    {        
        // Define the prefix for the name of the class we will load.
        public static string classNamePrefix = "FunctionXMLTest.FunctionXMLTest";
        ...
        static int Main(string[] args)
        {
            try
            {
                FunctionXMLTest FunctionXMLTest = new FunctionXMLTest( );
            
                // parse any command line arguments...
                FunctionXMLTest.parseCommandLineArgs( args );
