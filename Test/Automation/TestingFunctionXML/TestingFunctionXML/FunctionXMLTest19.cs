...
{
	/// <summary>
	/// Summary description for FunctionXMLTest19
	/// Make Functions.xml with Function ReturnType missing
	/// </summary>
	public class FunctionXMLTest19:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest19()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case:Make Functions.xml with Function ReturnType missing");
			try
			{
				string holodeckPath;
				...
				XmlNode nodeFunction = xmlDocument.SelectSingleNode( "/Functions/Function [last()]/ReturnType" );
