...
{
	/// <summary>
	/// Summary description for FunctionXMLTest39
	/// Make Functions.xml with Function Param Index missing
	/// </summary>
	public class FunctionXMLTest39:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest39()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case:Make Functions.xml with Function Param Index missing");
			try
			{
				string holodeckPath;
				...
				XmlNode nodeFunction = xmlDocument.SelectSingleNode( "/Functions/Function/Param[@Index]" );

				nodeFunction.Attributes.RemoveNamedItem("Index");
