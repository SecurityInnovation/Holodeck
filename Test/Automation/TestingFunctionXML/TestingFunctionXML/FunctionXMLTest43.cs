...
{
	/// <summary>
	/// Summary description for FunctionXMLTest43
	/// Make Functions.xml with Function Param Access missing
	/// </summary>
	public class FunctionXMLTest43:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest43()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case:Make Functions.xml with Function Param Access missing");
			try
			{
				string holodeckPath;
				...
				XmlNode nodeFunction = xmlDocument.SelectSingleNode( "/Functions/Function/Param[@Access]" );

				nodeFunction.Attributes.RemoveNamedItem("Access");
