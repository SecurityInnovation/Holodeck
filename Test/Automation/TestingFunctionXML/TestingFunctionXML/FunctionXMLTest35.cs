...
{
	/// <summary>
	/// Summary description for FunctionXMLTest35
	/// Make Functions.xml with Function ErrorCode Type missing
	/// </summary>
	public class FunctionXMLTest35:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest35()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case:Make Functions.xml with Function ErrorCode Type missing");
			try
			{
				string holodeckPath;
				...
				XmlNode nodeFunction = xmlDocument.SelectSingleNode( "/Functions/Function/ErrorCode[@Type]" );

				nodeFunction.Attributes.RemoveNamedItem("Type");
