...
{
	/// <summary>
	/// Summary description for FunctionXMLTest32
	/// Make Functions.xml with Function ErrorCode IdentifyBy Edited to IdentifyByTestName
	/// </summary>
	public class FunctionXMLTest32:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest32()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case:Make Make Functions.xml with Function ErrorCode IdentifyBy Edited to IdentifyByTestName");
			try
			{ 
				string holodeckPath;
				...
				XmlNode nodeFunction = xmlDocument.SelectSingleNode( "/Functions/Function/ErrorCode" );
								
				EditValues editIdentifyBy = new EditValues();
				editIdentifyBy.EditErrorCode(nodeFunction,testValue,"IdentifyBy");
