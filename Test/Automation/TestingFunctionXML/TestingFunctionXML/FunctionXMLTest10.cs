...
{
	/// <summary>
	/// Summary description for FunctionXMLTest10
	/// Make Functions.xml with Function FunctionName Value Edited to originalNameTestFunctionName
	/// </summary>
	public class FunctionXMLTest10:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest10()
		{
		...
		public override void executeTest( )
		{
			...
			try
			{
				...
				EditValues editFunctionName = new EditValues();
				editFunctionName.EditFunction(nodeFunction,testValue,"FunctionName");
