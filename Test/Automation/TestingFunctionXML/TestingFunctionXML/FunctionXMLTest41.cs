...
{
	/// <summary>
	/// Summary description for FunctionXMLTest41
	/// Make Functions.xml with Function Param CompareAs missing
	/// </summary>
	public class FunctionXMLTest41:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest41()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case:Make Functions.xml with Function Param CompareAs missing");
			try
			{
				string holodeckPath;
				...
				XmlNode nodeFunction = xmlDocument.SelectSingleNode( "/Functions/Function/Param[@CompareAs]" );

				nodeFunction.Attributes.RemoveNamedItem("CompareAs");
