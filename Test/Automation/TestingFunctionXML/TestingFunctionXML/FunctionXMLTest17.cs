...
{
	/// <summary>
	/// Summary description for FunctionXMLTest17
	/// Make Functions.xml with Function ReplacementFunctionName missing
	/// </summary>
	public class FunctionXMLTest17:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest17()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case: Make Functions.xml with Function ReplacementFunctionName missing");
			try
			{
				string holodeckPath;
				...
				XmlNode nodeFunction = xmlDocument.SelectSingleNode( "/Functions/Function [last()]/ReplacementFunctionName" );
