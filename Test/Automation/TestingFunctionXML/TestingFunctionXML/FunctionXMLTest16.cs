...
{
	/// <summary>
	/// Summary description for FunctionXMLTest16
	/// Make Functions.xml with Function InterceptedDll Value Edited to ReplacementFunctionName
	/// </summary>
	public class FunctionXMLTest16:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest16()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case:Make Functions.xml with Function ReplacementFunctionName Value Edited to ReplacementFunctionNameTestName");
			try
			{
				string holodeckPath;
				...
				EditValues editReplacementFunctionName = new EditValues();
				editReplacementFunctionName.EditFunction(nodeFunction,testValue,"ReplacementFunctionName");
