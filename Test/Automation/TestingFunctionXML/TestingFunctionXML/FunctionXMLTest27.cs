...
{
	/// <summary>
	/// Summary description for FunctionXMLTest27
	/// Make Functions.xml with Function ReturnValue NodeValue missing
	/// </summary>
	public class FunctionXMLTest27:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest27()
		{
