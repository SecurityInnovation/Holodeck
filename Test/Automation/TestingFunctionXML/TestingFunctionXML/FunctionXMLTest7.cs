...
{
	/// <summary>
	/// Summary description for FunctionXMLTest7
	/// Make Functions.xml with extra <Functions> tag "TestFunction"
	/// </summary>
	public class FunctionXMLTest7:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest7()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case: Make Functions.xml with extra <Functions> tag \"TestFunction\"");
			try
			{
				string holodeckPath;
				...
				//Element = Function
				XmlElement FuncElement = xmlDocument.CreateElement("Function");
				
				nodeFunction.ParentNode.AppendChild (FuncElement);

				//Element = FunctionName
				XmlElement elmFunctionName = xmlDocument.CreateElement("FunctionName");
				elmFunctionName.InnerText = "TestFunction";
