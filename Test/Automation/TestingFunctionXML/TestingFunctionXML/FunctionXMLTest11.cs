...
{
	/// <summary>
	/// Summary description for FunctionXMLTest11
	/// Make Functions.xml with Function FunctionName missing
	/// </summary>
	public class FunctionXMLTest11:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest11()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case:Make Functions.xml with Function FunctionName missing");
			try
			{
				string holodeckPath;
				...
				XmlNode nodeFunction = xmlDocument.SelectSingleNode( "/Functions/Function [last()]/FunctionName" );
