...
{
	/// <summary>
	/// Summary description for FunctionXMLTest25
	/// Make Functions.xml with Function HelpLink missing
	/// </summary>
	public class FunctionXMLTest25:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest25()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case:Make Functions.xml with Function HelpLink missing");
			try
			{
				string holodeckPath;
				...
				XmlNode nodeFunction = xmlDocument.SelectSingleNode( "/Functions/Function [last()]/HelpLink" );
