...
{
	/// <summary>
	/// Summary description for FunctionXMLTest4.
	/// Make Functions.xml with only <Functions> tag
	/// </summary>
	public class FunctionXMLTest4:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest4()
		{
