...
{
	/// <summary>
	/// Summary description for FunctionXMLTest6.
	/// Make Functions.xml with edited value of <Functions> tag to <Functions> testFunctions </Functions>
	/// </summary>
	public class FunctionXMLTest6:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest6()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case : Make Functions.xml with edited value of <Functions> tag to <Functions> testFunctions </Functions>");
			try
			{
				string holodeckPath;
				...
				node.InnerText= "TestFunctions".ToString();
