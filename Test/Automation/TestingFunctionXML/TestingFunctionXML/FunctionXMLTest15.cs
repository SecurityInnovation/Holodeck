...
namespace FunctionXMLTest
{
	...
	public class FunctionXMLTest15:FunctionXMLTest
	{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case:Make Functions.xml with Function InterceptedDll missing");
			try
			{
				string holodeckPath;
				...
				XmlNode nodeFunction = xmlDocument.SelectSingleNode( "/Functions/Function [last()]/InterceptedDll" );
