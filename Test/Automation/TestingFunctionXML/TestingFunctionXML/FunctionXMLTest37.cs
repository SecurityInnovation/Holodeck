...
{
	/// <summary>
	/// Summary description for FunctionXMLTest37
	/// Make Functions.xml with Function Param Type missing
	/// </summary>
	public class FunctionXMLTest37:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest37()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case:Make Functions.xml with Function Param Type missing");
			try
			{
				string holodeckPath;
				...
				XmlNode nodeFunction = xmlDocument.SelectSingleNode( "/Functions/Function/Param[@Type]" );
