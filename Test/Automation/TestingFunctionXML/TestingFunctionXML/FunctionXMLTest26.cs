...
{
	/// <summary>
	/// Summary description for FunctionXMLTest26
	/// Make Functions.xml with Function ReturnValue NodeValue Edited to NodeValueTestName
	/// </summary>
	public class FunctionXMLTest26:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest26()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case:Make Functions.xml with Function ReturnValue NodeValue Edited to NodeValueTestName");
			try
			{
				string holodeckPath;
				...
				EditValues editNodeValue = new EditValues();
				editNodeValue.EditReturnValue(nodeFunction,testValue,"NodeValue");
