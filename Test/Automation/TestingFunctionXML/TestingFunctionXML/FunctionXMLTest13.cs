...
{
	/// <summary>
	/// Summary description for FunctionXMLTest13
	/// Make Functions.xml with Function OriginalDll missing
	/// </summary>
	public class FunctionXMLTest13:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest13()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case:Make Functions.xml with Function OriginalDll missing");
			try
			{
				string holodeckPath;
				...
				XmlNode nodeFunction = xmlDocument.SelectSingleNode( "/Functions/Function [last()]/OriginalDll" );
