...
{
	/// <summary>
	/// Summary description for FunctionXMLTest24
	/// Make Functions.xml with Function HelpLink Value Edited to HelpLinkTestName
	/// </summary>
	public class FunctionXMLTest24:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest24()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case:Make Functions.xml with Function HelpLink Value Edited to HelpLinkTestName");
			try
			{
				string holodeckPath;
				...
				EditValues editHelpLink = new EditValues();
				editHelpLink.EditFunction(nodeFunction,testValue,"HelpLink");
