...
{
	/// <summary>
	/// Summary description for FunctionXMLTest29
	/// Make Functions.xml with Function ReturnValue Type missing
	/// </summary>
	public class FunctionXMLTest29:FunctionXMLTest
	{
		string FunctionsXMLFilePath;
		string FunctionsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FunctionXMLTest29()
		{
		...
		public override void executeTest( )
		{
			...
			Console.WriteLine("Test Case:Make Functions.xml with Function ReturnValue NodeValue missing");
			try
			{
				string holodeckPath;
				...
				cloneNode.RemoveAll();
				cloneNode.InnerXml = nodeFunction.InnerXml ;
