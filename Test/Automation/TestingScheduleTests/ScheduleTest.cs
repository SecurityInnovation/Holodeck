...
namespace ScheduleTest
{
	...
	public class ScheduleTest : RunTest
	{        
		// Define the prefix for the name of the class we will load.
		public static string classNamePrefix        = "ScheduleTest.ScheduleTest";
		public static string functionToBeTested = "NotYetSpecified";
		...
		static int Main(string[] args)
		{
			try
			{
				functionToBeTested = args[1];
				ScheduleTest ScheduleTest = new ScheduleTest( );
				// parse any command line arguments...
				ScheduleTest.parseCommandLineArgs( args );
