...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest2:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest2()
		{
			//
		...
		{
			Console.WriteLine("Test Case 1 :TOO MANY OPEN FILES Fault activated");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("Too_Many_Open_Files");
