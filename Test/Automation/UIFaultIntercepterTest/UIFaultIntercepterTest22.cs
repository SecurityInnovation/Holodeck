...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest22:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest22()
		{
			//
		...
		{
			Console.WriteLine("Test Case 22 :WINSOCK TASK LIMIT REACHED Fault activated");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("Winsock_Task_Limit_Reached");
