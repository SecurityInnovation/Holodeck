...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest35:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest35()
		{
			//
		...
		{
			Console.WriteLine("Test Case 35 :Registry Fault - Registry Is Corrupt");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("Registry_Is_Corrupt");
