...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest33:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest33()
		{
			//
		...
		{
			Console.WriteLine("Test Case 33 :Registry Fault - Query Buffer Too Small ");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("Query_Buffer_Too_Small");
