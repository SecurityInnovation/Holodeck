...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest36:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest36()
		{
			//
		...
		{
			Console.WriteLine("Test Case 36 :Registry Fault - Key Is Corrupt");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("Key_Is_Corrupt");
