...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest23:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest23()
		{
			//
		...
		{
			Console.WriteLine("Test Case 23 :NO PORTS AVAILABLE Fault activated");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
		t.GetHolodeck("No_Ports_Available");
