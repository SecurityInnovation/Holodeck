...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest34:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest34()
		{
			//
		...
		{
			Console.WriteLine("Test Case 34 :Registry Fault - No More Query Items ");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("No_More_Query_Items");
