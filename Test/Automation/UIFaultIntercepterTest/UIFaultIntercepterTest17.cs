...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest17:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest17()
		{
			//
		...
		{
			Console.WriteLine("Test Case 17 :INVALID ADDRESS Fault activated");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("Invalid_Address");
