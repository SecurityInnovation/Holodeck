...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest5:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest5()
		{
			//
		...
		{
			Console.WriteLine("Test Case 5 :DATA ERROR Fault activated");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("Data_Error");
