...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest20:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest20()
		{
			//
		...
		{
			Console.WriteLine("Test Case 20 :NETWORK NOT INSTALLED Fault activated");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("Network_Not_Installed");
