...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest30:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest30()
		{
			//
		...
		{
			Console.WriteLine("Test Case 30 :Registry Fault - Key Not Found ");
