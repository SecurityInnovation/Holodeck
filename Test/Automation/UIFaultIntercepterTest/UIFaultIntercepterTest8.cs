...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest8:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest8()
		{
			//
		...
		{
			Console.WriteLine("Test Case 8 :FILE LOCKED Fault activated");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
		t.GetHolodeck("File_Locked");
