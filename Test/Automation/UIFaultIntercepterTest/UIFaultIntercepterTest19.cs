...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest19:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest19()
		{
			//
		...
		{
			Console.WriteLine("Test Case 19 :NETWORK DISCONNECTED Fault activated");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("Network_Disconnected");
