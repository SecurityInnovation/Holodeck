...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest45:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest45()
		{
			//
		...
		{
			Console.WriteLine("Test Case 45 :Process/Library Fault - Invalid File Type");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("Invalid_File_Type");
