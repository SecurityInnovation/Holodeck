...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest9:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest9()
		{
			//
		...
		{
			Console.WriteLine("Test Case 9 :DISK FULL Fault activated");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("Disk_Full");
