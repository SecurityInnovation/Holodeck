...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest6:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest6()
		{
			//
		...
		{
			Console.WriteLine("Test Case 6 :DRIVE CAN'T SEEK DISK Fault activated");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("Drive_Can't_Seek_Disk");
