...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest38:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest38()
		{
			//
		...
		{
			Console.WriteLine("Test Case 38 :Registry Fault - Value Cannot Be Read ");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("Value_Cannot_Be_Read");
