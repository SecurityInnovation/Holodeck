...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest4:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest4()
		{
			//
		...
		{
			Console.WriteLine("Test Case 1 :READ ONLY Fault activated");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("Read_Only");
