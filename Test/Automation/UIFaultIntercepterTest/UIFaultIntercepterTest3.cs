...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest3:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest3()
		{
			//
		...
		{
			Console.WriteLine("Test Case 1 :ACCESS DENIED TO FILE Fault activated");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("Access_Denied_To_File");
