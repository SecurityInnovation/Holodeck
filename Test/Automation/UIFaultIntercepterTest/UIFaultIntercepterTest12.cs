...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest12:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest12()
		{
			//
		...
		{
			Console.WriteLine("Test Case 12 :CAN'T REMOVE DIRECTORY Fault activated");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("Can't_Remove_Directory");
