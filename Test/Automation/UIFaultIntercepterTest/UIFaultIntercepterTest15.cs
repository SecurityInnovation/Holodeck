...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest15:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest15()
		{
			//
		...
		{
			Console.WriteLine("Test Case 15 :INVALID ACCESS Fault activated");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("Invalid_Access");
