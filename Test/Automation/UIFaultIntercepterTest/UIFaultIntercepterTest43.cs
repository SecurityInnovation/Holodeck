...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest43:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest43()
		{
			//
		...
		{
			Console.WriteLine("Test Case 43 :Process/Library Fault  - Process File Not Found");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("Process_File_Not_Found");
