...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest18:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest18()
		{
			//
		...
		{
			Console.WriteLine("Test Case 18 :PAGE FILE TOO SMALL Fault activated");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("Page_File_Too_Small");
