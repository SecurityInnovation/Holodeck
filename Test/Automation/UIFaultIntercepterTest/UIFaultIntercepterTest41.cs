...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest41:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest41()
		{
			//
		...
		{
			Console.WriteLine("Test Case 41 :Registry Fault - Key Marked For Deletion");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("Key_Marked_For_Deletion");
