...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest24:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest24()
		{
			//
		...
		{
			Console.WriteLine("Test Case 24 :NETWORK DOWN Fault activated");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("Network_Down");
