...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest7:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest7()
		{
			//
		...
		{
			Console.WriteLine("Test Case 7 :FILE IN USE Fault activated");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("File_In_Use");
