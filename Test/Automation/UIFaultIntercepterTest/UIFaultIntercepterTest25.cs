...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest25:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest25()
		{
			//
		...
		{
			Console.WriteLine("Test Case 25 :File Not Found Fault and Network Down Fault");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("File_Not_Found Network_Down");
