...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest39:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest39()
		{
			//
		...
		{
			Console.WriteLine("Test Case 39 :Registry Fault - Value Cannot Be Written");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("Value_Cannot_Be_Written");
