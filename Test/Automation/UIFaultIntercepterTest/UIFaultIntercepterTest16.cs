...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest16:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest16()
		{
			//
		...
		{
			Console.WriteLine("Test Case 16 :SEGMENT LOCKED Fault activated");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("Segment_Locked");
