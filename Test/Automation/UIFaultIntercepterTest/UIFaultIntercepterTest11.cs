...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest11:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest11()
		{
			//
		...
		{
			Console.WriteLine("Test Case 11 :FILE CAN'T BE CREATED Fault activated");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("File_Can't_Be_Created");
