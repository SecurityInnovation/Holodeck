...
namespace UIFaultIntercepterTest
{
	...
	/// </summary>
	public class UIFaultIntercepterTest10:UIFaultIntercepterTest
	{
		...
		public UIFaultIntercepterTest10()
		{
			//
		...
		{
			Console.WriteLine("Test Case 10 :FILE ALREADY EXISTS Fault activated");
			UIFaultIntercepterTest1 t = new UIFaultIntercepterTest1();
			//launch HD
			t.GetHolodeck("File_Already_Exists");
