...
{
	/// <summary>
	/// Summary description for TestingXML18.
	/// Extra Child Element is added to the root element
	/// </summary>
	public class TestingXML18:TestingXML
	{
		public TestingXML18()
		{
		...
		{
			Console.WriteLine("Test Case 18 : Extra Child Element is added to the root element");
			try
			{
				string holodeckPath;
				...
				XmlElement newElement = xmlDocument.CreateElement(testValue);
				newElement.InnerText = testValue;
