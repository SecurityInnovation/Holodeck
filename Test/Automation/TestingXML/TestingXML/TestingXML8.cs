...
{
	/// <summary>
	/// Summary description for TestingXML8.
	/// Change xml file attribute as Archive file
	/// </summary>
	public class TestingXML8:TestingXML
	{
		public TestingXML8()
		{
		...
		{
			Console.WriteLine("Test Case 8:Change xml file attribute as Archive file");
			try
			{
				string holodeckPath;
				...
				modifyThisFile.Attributes = FileAttributes.Archive;
