...
{
	/// <summary>
	/// Summary description for TestingXML14.
	/// Remove First Child-Element from xml file 
	/// </summary>
	public class TestingXML14:TestingXML
	{
		public TestingXML14()
		{
		...
		{
			Console.WriteLine("Test Case 14 : Remove First Child-Element from xml file");
			try
			{
				string holodeckPath;
				...
				XmlNode nodeToRemove = node.FirstChild;
