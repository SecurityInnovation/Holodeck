...
{
	/// <summary>
	/// Summary description for TestingXML12.
	/// Duplicate Child-Element inserted in xml file
	/// </summary>
	public class TestingXML12:TestingXML
	{
		public TestingXML12()
		{
		...
		{
			Console.WriteLine("Test Case 12 : Duplicate Child-Element inserted in xml file");
			try
			{
				string holodeckPath;
