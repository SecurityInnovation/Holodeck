...
{
	/// <summary>
	/// Summary description for TestingXML10.
	/// Change xml file attribute as Directory
	/// </summary>
	public class TestingXML10:TestingXML
	{
		public TestingXML10()
		{
		...
		{
			Console.WriteLine("Test Case 9:Change xml file attribute as Directory i.e. The file is a directory");
			try
			{
				string holodeckPath;
				...
				modifyThisFile.Attributes = FileAttributes.Directory;
