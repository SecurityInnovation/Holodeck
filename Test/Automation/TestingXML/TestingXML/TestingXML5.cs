...
{
	/// <summary>
	/// Summary description for TestingXML5.
	/// Change xml file attribute as encrypted  file
	/// </summary>
	public class TestingXML5:TestingXML
	{
		public TestingXML5()
		{
		...
		{
			Console.WriteLine("Test Case 5 :Change xml file attribute as encrypted file");
			try
			{
				string holodeckPath;
				...
				modifyThisFile.Attributes = FileAttributes.Encrypted;
