...
{
	/// <summary>
	/// Summary description for TestingXML19.
	/// Removing DTD from File
	/// </summary>
	public class TestingXML19:TestingXML
	{
		public TestingXML19()
		{
		...
		{
			Console.WriteLine("Test Case 19 : Removing DTD from File ####This does not work ###");
			try
			{
				string holodeckPath;
				...
				xmlDocument.DocumentType.SystemId.Replace(xmlDocument.DocumentType.SystemId,testValue);
				string [] xmlLines = xmlDocument.OuterXml.Split( '\n' );

				// Initialize the string to contain the newly formatted xml...
				string newXmlFormat = null;
				...
				xmlDocument.LoadXml( newXmlFormat );
