...
{
	/// <summary>
	/// Summary description for TestingXML4.
	/// Change xml file attribute as hidden  file
	/// </summary>
	public class TestingXML4:TestingXML
	{
		public TestingXML4()
		{
		...
		{
			Console.WriteLine("Test Case 4 :Change xml file attribute as hidden file");
			try
			{
				string holodeckPath;
				...
				modifyThisFile.Attributes = FileAttributes.Hidden;
