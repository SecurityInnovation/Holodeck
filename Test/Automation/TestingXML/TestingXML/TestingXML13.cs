...
{
	/// <summary>
	/// Summary description for TestingXML13.
	/// Duplicate Child-Element inserted in xml file with extra inner text 
	/// </summary>
	public class TestingXML13:TestingXML
	{
		public TestingXML13()
		{
		...
		{
			Console.WriteLine("Test Case 13 : Duplicate Child-Element inserted in xml file with extra inner text");
			try
			{
				string holodeckPath;
				...
				XmlNode nodeToAdd = node.FirstChild.Clone();

				nodeToAdd.InnerText = testValue;
