...
{
	/// <summary>
	/// Summary description for TestingXML3.
	/// Change xml file attribute as read-only file
	/// </summary>
	public class TestingXML3:TestingXML
	{
		public TestingXML3()
		{
		...
		{
			Console.WriteLine("Test Case 3 :Change xml file attribute as read-only file");
			try
			{
				string holodeckPath;
				...
				modifyThisFile.Attributes = FileAttributes.ReadOnly;
