...
{
	/// <summary>
	/// Summary description for FaultXMLTest42.
	/// Make Faults.xml with 'Faults Fault Function PassThrough' Value Edited to "originalValue + testValue"
	/// </summary>
	public class FaultXMLTest42:FaultXMLTest
	{
		string FaultsXMLFilePath;
		string FaultsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FaultXMLTest42()
		{
		...
		{
			Console.WriteLine("Test Case :Make Faults.xml with 'Faults Fault Function PassThrough' Value Edited to \"originalValue + testValue\"");
			try
			{
				string holodeckPath;
				...
				EditValues editPassThrough = new EditValues();
				editPassThrough.EditFunction(nodeFunction,testValue,"PassThrough");
