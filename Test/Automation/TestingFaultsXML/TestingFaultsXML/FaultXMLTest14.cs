...
{
	/// <summary>
	/// Summary description for FaultXMLTest14
	/// Make Faults.xml with Faults Fault ErrorCode Value Edited to "originalValue + testValue"
	/// </summary>
	public class FaultXMLTest14:FaultXMLTest
	{
		string FaultsXMLFilePath;
		string FaultsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FaultXMLTest14()
		{
