...
{
	/// <summary>
	/// Summary description for FaultXMLTest22.
	/// Make Faults.xml with 'Faults Fault Function MatchParams MatchParam TestOperator' Value Edited to "originalValue + testValue"
	/// </summary>
	public class FaultXMLTest22:FaultXMLTest
	{
		string FaultsXMLFilePath;
		string FaultsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FaultXMLTest22()
		{
		...
		{
			Console.WriteLine("Test Case :Make Faults.xml with 'Faults Fault Function MatchParams MatchParam TestOperator' Value Edited to \"originalValue + testValue\"");
			try
			{
				string holodeckPath;
				...
				EditValues editMatchParamTestOperator = new EditValues();
				editMatchParamTestOperator.EditMatchParam(nodeMatchParam,testValue,"TestOperator");
