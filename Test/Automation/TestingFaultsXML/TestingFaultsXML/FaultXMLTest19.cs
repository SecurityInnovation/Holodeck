...
{
	/// <summary>
	/// Summary description for FaultXMLTest19.
	/// Make Faults.xml with one missing MatchParam
	/// </summary>
	public class FaultXMLTest19:FaultXMLTest
	{
		string FaultsXMLFilePath;
		string FaultsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FaultXMLTest19()
		{
		...
		{
			Console.WriteLine("Test Case :Make Faults.xml with one missing MatchParam");
			try
			{
				string holodeckPath;
				...
				nodeMatchParam.ParentNode.RemoveChild(nodeMatchParam);
