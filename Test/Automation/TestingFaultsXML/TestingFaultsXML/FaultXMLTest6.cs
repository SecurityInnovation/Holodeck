...
{
	/// <summary>
	/// Summary description for FaultXMLTest6.
	/// Make Faults.xml with edited value of <Faults> tag to <Faults> testValue <Faults>
	/// </summary>
	public class FaultXMLTest6:FaultXMLTest
	{
		string FaultsXMLFilePath;
		string FaultsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FaultXMLTest6()
		{
		...
		{
			Console.WriteLine("Test Case :  Make Faults.xml with edited value of <Faults> tag to <Faults> testValue <Faults> ");
			try
			{
				string holodeckPath;
				...
				node.InnerText = testValue.ToString();
