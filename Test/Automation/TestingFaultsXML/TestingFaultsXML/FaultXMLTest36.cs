...
{
	/// <summary>
	/// Summary description for FaultXMLTest36.
	/// Make Faults.xml with 'Faults Fault Function Name' Value Edited to "originalValue + testValue"
	/// </summary>
	public class FaultXMLTest36:FaultXMLTest
	{
		string FaultsXMLFilePath;
		string FaultsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FaultXMLTest36()
		{
		...
		{
			Console.WriteLine("Test Case :Make Faults.xml with 'Faults Fault Function Name' Value Edited to \"originalValue + testValue\"");
			try
			{
				string holodeckPath;
				...
				EditValues editName = new EditValues();
				editName.EditFunction(nodeFunction,testValue,"Name");
