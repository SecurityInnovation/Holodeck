...
{
	/// <summary>
	/// Summary description for FaultXMLTest20.
	/// Make Faults.xml with 'Faults Fault Function MatchParams MatchParam Name' Value Edited to "originalValue + testValue"
	/// </summary>
	public class FaultXMLTest20:FaultXMLTest
	{
		string FaultsXMLFilePath;
		string FaultsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FaultXMLTest20()
		{
		...
		{
			Console.WriteLine("Test Case :Make Faults.xml with 'Faults Fault Function MatchParams MatchParam Name' Value Edited to \"originalValue + testValue\"");
			try
			{
				string holodeckPath;
				...
				EditValues editMatchParamName = new EditValues();
				editMatchParamName.EditMatchParam(nodeMatchParam,testValue,"Name");
