...
{
	/// <summary>
	/// Summary description for FaultXMLTest40.
	/// Make Faults.xml with 'Faults Fault Function OverrideReturnValue' Value Edited to "originalValue + testValue"
	/// </summary>
	public class FaultXMLTest40:FaultXMLTest
	{
		string FaultsXMLFilePath;
		string FaultsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FaultXMLTest40()
		{
		...
		{
			Console.WriteLine("Test Case :Make Faults.xml with 'Faults Fault Function OverrideReturnValue' Value Edited to \"originalValue + testValue\"");
			try
			{
				string holodeckPath;
				...
				EditValues editOverrideReturnValue = new EditValues();
				editOverrideReturnValue.EditFunction(nodeFunction,testValue,"OverrideReturnValue");
