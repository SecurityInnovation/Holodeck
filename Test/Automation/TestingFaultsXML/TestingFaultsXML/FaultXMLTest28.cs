...
{
	/// <summary>
	/// Summary description for FaultXMLTest28.
	/// Make Faults.xml with 'Faults Fault Function MatchParams MatchParam ID' Value Edited to "originalValue + testValue"
	/// </summary>
	public class FaultXMLTest28:FaultXMLTest
	{
		string FaultsXMLFilePath;
		string FaultsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FaultXMLTest28()
		{
		...
		{
			Console.WriteLine("Test Case : Make Faults.xml with 'Faults Fault Function MatchParams MatchParam ID' Value Edited to \"originalValue + testValue\"");
			try
			{
				string holodeckPath;
				...
				EditValues editMatchParamID = new EditValues();
				editMatchParamID.EditMatchParam(nodeMatchParam,testValue,"ID");
