...
{
	/// <summary>
	/// Summary description for FaultXMLTest26.
	/// Make Faults.xml with 'Faults Fault Function MatchParams MatchParam CompareAsType' Value Edited to "originalValue + testValue"
	/// </summary>
	public class FaultXMLTest26:FaultXMLTest
	{
		string FaultsXMLFilePath;
		string FaultsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FaultXMLTest26()
		{
		...
		{
			Console.WriteLine("Test Case :Make Faults.xml with 'Faults Fault Function MatchParams MatchParam CompareAsType' Value Edited to \"originalValue + testValue\"");
			try
			{
				string holodeckPath;
				...
				EditValues editMatchParamCompareAsType = new EditValues();
				editMatchParamCompareAsType.EditMatchParam(nodeMatchParam,testValue,"CompareAsType");
