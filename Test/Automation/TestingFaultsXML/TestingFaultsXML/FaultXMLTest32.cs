...
{
	/// <summary>
	/// Summary description for FaultXMLTest32.
	/// Make Faults.xml with 'Faults Fault Function CheckResource ParamIndex' Value Edited to "originalValue + testValue"
	/// </summary>
	public class FaultXMLTest32:FaultXMLTest
	{
		string FaultsXMLFilePath;
		string FaultsXMLBackupFilePath;
		FileInfo modifyThisFile;

		public FaultXMLTest32()
		{
