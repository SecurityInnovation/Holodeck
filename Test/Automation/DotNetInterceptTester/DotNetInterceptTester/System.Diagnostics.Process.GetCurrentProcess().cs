...
{
public static bool _GetCurrentProcess( )
{
   //Parameters
   ...
   try
   {
      returnValue_Real = System.Diagnostics.Process.GetCurrentProcess(;
   }
   ...
   try
   {
      returnValue_Intercepted = System.Diagnostics.Process.GetCurrentProcess(;
   }
