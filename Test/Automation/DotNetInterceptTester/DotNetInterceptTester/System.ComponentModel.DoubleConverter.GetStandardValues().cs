...
{
public class GetStandardValues_System_ComponentModel_DoubleConverter
{
public static bool _GetStandardValues_System_ComponentModel_DoubleConverter( )
{
   ...
   try
   {
      returnVal_Real = _System_ComponentModel_DoubleConverter.GetStandardValues();
   }
   ...
   try
   {
      returnVal_Intercepted = _System_ComponentModel_DoubleConverter.GetStandardValues();
   }
