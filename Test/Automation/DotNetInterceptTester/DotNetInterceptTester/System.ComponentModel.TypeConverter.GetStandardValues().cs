...
{
public class GetStandardValues_System_ComponentModel_TypeConverter
{
public static bool _GetStandardValues_System_ComponentModel_TypeConverter( )
{
   ...
   try
   {
      returnVal_Real = _System_ComponentModel_TypeConverter.GetStandardValues();
   }
   ...
   try
   {
      returnVal_Intercepted = _System_ComponentModel_TypeConverter.GetStandardValues();
   }
