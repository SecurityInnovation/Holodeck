...
public static bool _BeginGetRequestStream_System_Net_FileWebRequest_System_AsyncCallback_System_Object( )
{
   ...
   try
   {
      returnValue_Real = System.Net.FileWebRequest.BeginGetRequestStream(callback,state);
   }
   ...
   try
   {
      returnValue_Intercepted = System.Net.FileWebRequest.BeginGetRequestStream(callback,state);
   }
