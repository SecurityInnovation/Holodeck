...
{
public class GetStandardValues_System_ComponentModel_EnumConverter
{
public static bool _GetStandardValues_System_ComponentModel_EnumConverter( )
{
   ...
   try
   {
      returnVal_Real = _System_ComponentModel_EnumConverter.GetStandardValues();
   }
   ...
   try
   {
      returnVal_Intercepted = _System_ComponentModel_EnumConverter.GetStandardValues();
   }
