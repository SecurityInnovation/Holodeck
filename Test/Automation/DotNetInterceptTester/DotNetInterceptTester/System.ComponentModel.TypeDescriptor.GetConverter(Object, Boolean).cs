...
{
public class GetConverter_System_Object_System_Boolean
{
public static bool _GetConverter_System_Object_System_Boolean( )
{
   ...
   try
   {
      returnVal_Real = _System_ComponentModel_TypeDescriptor.GetConverter(component,noCustomTypeDesc);
   }
   ...
   try
   {
      returnVal_Intercepted = _System_ComponentModel_TypeDescriptor.GetConverter(component,noCustomTypeDesc);
   }
