...
public static bool _Exists_System_String( )
{
   ...
   try
   {
      returnValue_Real = System.Diagnostics.PerformanceCounterCategory.Exists(categoryName);
   }
   ...
   try
   {
      returnValue_Intercepted = System.Diagnostics.PerformanceCounterCategory.Exists(categoryName);
   }
