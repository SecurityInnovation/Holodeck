...
public static bool _SetLastAccessTimeUtc_System_String_System_DateTime( )
{
   ...
   try
   {
      returnValue_Real = System.IO.Directory.SetLastAccessTimeUtc(path,lastAccessTimeUtc);
   }
   ...
   try
   {
      returnValue_Intercepted = System.IO.Directory.SetLastAccessTimeUtc(path,lastAccessTimeUtc);
   }
