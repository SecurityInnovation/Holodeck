...
{
public class GetProperties_System_Object
{
public static bool _GetProperties_System_Object( )
{
   ...
   try
   {
      returnVal_Real = _System_ComponentModel_TypeDescriptor.GetProperties(component);
   }
   ...
   try
   {
      returnVal_Intercepted = _System_ComponentModel_TypeDescriptor.GetProperties(component);
   }
