...
{
public class GetStandardValues_System_ComponentModel_UInt16Converter
{
public static bool _GetStandardValues_System_ComponentModel_UInt16Converter( )
{
   ...
   try
   {
      returnVal_Real = _System_ComponentModel_UInt16Converter.GetStandardValues();
   }
   ...
   try
   {
      returnVal_Intercepted = _System_ComponentModel_UInt16Converter.GetStandardValues();
   }
