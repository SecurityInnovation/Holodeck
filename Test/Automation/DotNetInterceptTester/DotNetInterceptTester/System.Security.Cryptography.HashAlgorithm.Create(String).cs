...
public static bool _Create_System_String( )
{
   ...
   try
   {
      returnValue_Real = System.Security.Cryptography.HashAlgorithm.Create(hashName);
   }
   ...
   try
   {
      returnValue_Intercepted = System.Security.Cryptography.HashAlgorithm.Create(hashName);
   }
