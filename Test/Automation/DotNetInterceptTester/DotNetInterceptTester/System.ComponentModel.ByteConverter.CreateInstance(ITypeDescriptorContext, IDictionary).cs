...
{
public class CreateInstance_System_ComponentModel_ByteConverter_System_ComponentModel_ITypeDescriptorContext_System_Collections_IDictionary
{
public static bool _CreateInstance_System_ComponentModel_ByteConverter_System_ComponentModel_ITypeDescriptorContext_System_Collections_IDictionary( )
{
   ...
   try
   {
      returnVal_Real = _System_ComponentModel_ByteConverter.CreateInstance(context,propertyValues);
   }
   ...
   try
   {
      returnVal_Intercepted = _System_ComponentModel_ByteConverter.CreateInstance(context,propertyValues);
   }
