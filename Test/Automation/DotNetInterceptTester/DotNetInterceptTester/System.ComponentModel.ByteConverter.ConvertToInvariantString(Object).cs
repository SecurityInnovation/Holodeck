...
{
public class ConvertToInvariantString_System_ComponentModel_ByteConverter_System_Object
{
public static bool _ConvertToInvariantString_System_ComponentModel_ByteConverter_System_Object( )
{
   ...
   try
   {
      returnVal_Real = _System_ComponentModel_ByteConverter.ConvertToInvariantString(_value);
   }
   ...
   try
   {
      returnVal_Intercepted = _System_ComponentModel_ByteConverter.ConvertToInvariantString(_value);
   }
