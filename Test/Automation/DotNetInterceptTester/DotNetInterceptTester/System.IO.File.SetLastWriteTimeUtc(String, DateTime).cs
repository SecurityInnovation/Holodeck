...
public static bool _SetLastWriteTimeUtc_System_String_System_DateTime( )
{
   ...
   try
   {
      returnValue_Real = System.IO.File.SetLastWriteTimeUtc(path,lastWriteTimeUtc);
   }
   ...
   try
   {
      returnValue_Intercepted = System.IO.File.SetLastWriteTimeUtc(path,lastWriteTimeUtc);
   }
