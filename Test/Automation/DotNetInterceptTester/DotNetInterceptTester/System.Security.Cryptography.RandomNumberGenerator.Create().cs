...
public static bool _Create( )
{
   ...
   try
   {
      returnValue_Real = System.Security.Cryptography.RandomNumberGenerator.Create(;
   }
   ...
   try
   {
      returnValue_Intercepted = System.Security.Cryptography.RandomNumberGenerator.Create(;
   }
