...
{
public class GetStandardValues_System_ComponentModel_GuidConverter
{
public static bool _GetStandardValues_System_ComponentModel_GuidConverter( )
{
   ...
   try
   {
      returnVal_Real = _System_ComponentModel_GuidConverter.GetStandardValues();
   }
   ...
   try
   {
      returnVal_Intercepted = _System_ComponentModel_GuidConverter.GetStandardValues();
   }
