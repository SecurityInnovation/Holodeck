...
{
public class GetEvents_System_Type
{
public static bool _GetEvents_System_Type( )
{
   ...
   try
   {
      returnVal_Real = _System_ComponentModel_TypeDescriptor.GetEvents(componentType);
   }
   ...
   try
   {
      returnVal_Intercepted = _System_ComponentModel_TypeDescriptor.GetEvents(componentType);
   }
