...
{
public class GetEvents_System_Object_System_Boolean
{
public static bool _GetEvents_System_Object_System_Boolean( )
{
   ...
   try
   {
      returnVal_Real = _System_ComponentModel_TypeDescriptor.GetEvents(component,noCustomTypeDesc);
   }
   ...
   try
   {
      returnVal_Intercepted = _System_ComponentModel_TypeDescriptor.GetEvents(component,noCustomTypeDesc);
   }
