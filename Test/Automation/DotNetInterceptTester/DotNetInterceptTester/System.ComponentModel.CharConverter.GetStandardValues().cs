...
{
public class GetStandardValues_System_ComponentModel_CharConverter
{
public static bool _GetStandardValues_System_ComponentModel_CharConverter( )
{
   ...
   try
   {
      returnVal_Real = _System_ComponentModel_CharConverter.GetStandardValues();
   }
   ...
   try
   {
      returnVal_Intercepted = _System_ComponentModel_CharConverter.GetStandardValues();
   }
