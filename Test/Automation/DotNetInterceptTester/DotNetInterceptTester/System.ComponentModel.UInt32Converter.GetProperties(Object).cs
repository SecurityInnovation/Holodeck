...
{
public class GetProperties_System_ComponentModel_UInt32Converter_System_Object
{
public static bool _GetProperties_System_ComponentModel_UInt32Converter_System_Object( )
{
   ...
   try
   {
      returnVal_Real = _System_ComponentModel_UInt32Converter.GetProperties(_value);
   }
   ...
   try
   {
      returnVal_Intercepted = _System_ComponentModel_UInt32Converter.GetProperties(_value);
   }
