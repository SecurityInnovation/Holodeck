...
{
public class GetDefaultProperty_System_Object_System_Boolean
{
public static bool _GetDefaultProperty_System_Object_System_Boolean( )
{
   ...
   try
   {
      returnVal_Real = _System_ComponentModel_TypeDescriptor.GetDefaultProperty(component,noCustomTypeDesc);
   }
   ...
   try
   {
      returnVal_Intercepted = _System_ComponentModel_TypeDescriptor.GetDefaultProperty(component,noCustomTypeDesc);
   }
