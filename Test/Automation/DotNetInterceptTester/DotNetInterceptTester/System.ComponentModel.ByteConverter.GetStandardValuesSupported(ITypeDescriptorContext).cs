...
{
public class GetStandardValuesSupported_System_ComponentModel_ByteConverter_System_ComponentModel_ITypeDescriptorContext
{
public static bool _GetStandardValuesSupported_System_ComponentModel_ByteConverter_System_ComponentModel_ITypeDescriptorContext( )
{
   ...
   try
   {
      returnVal_Real = _System_ComponentModel_ByteConverter.GetStandardValuesSupported(context);
   }
   ...
   try
   {
      returnVal_Intercepted = _System_ComponentModel_ByteConverter.GetStandardValuesSupported(context);
   }
