...
{
public class ctor_System_ComponentModel_Design_DesignerTransaction
{
public static bool _ctor_System_ComponentModel_Design_DesignerTransaction( )
{
   ...
   try
   {
      _System_ComponentModel_Design_DesignerTransaction.ctor();
   }
