...
{
public class GetStandardValues_System_ComponentModel_ComponentConverter
{
public static bool _GetStandardValues_System_ComponentModel_ComponentConverter( )
{
   ...
   try
   {
      returnVal_Real = _System_ComponentModel_ComponentConverter.GetStandardValues();
   }
   ...
   try
   {
      returnVal_Intercepted = _System_ComponentModel_ComponentConverter.GetStandardValues();
   }
