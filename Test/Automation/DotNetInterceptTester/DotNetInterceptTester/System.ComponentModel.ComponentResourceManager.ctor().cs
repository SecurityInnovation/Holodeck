...
{
public class ctor_System_ComponentModel_ComponentResourceManager
{
public static bool _ctor_System_ComponentModel_ComponentResourceManager( )
{
   ...
   try
   {
      _System_ComponentModel_ComponentResourceManager.ctor();
   }
