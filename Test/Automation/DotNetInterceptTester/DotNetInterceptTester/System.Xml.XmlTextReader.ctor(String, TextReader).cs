...
{
public class ctor_System_Xml_XmlTextReader_System_String_System_IO_TextReader
{
public static bool _ctor_System_Xml_XmlTextReader_System_String_System_IO_TextReader( )
{
   //Parameters
