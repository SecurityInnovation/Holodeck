...
{
public class GetConverter_System_Object
{
public static bool _GetConverter_System_Object( )
{
   ...
   try
   {
      returnVal_Real = _System_ComponentModel_TypeDescriptor.GetConverter(component);
   }
   ...
   try
   {
      returnVal_Intercepted = _System_ComponentModel_TypeDescriptor.GetConverter(component);
   }
