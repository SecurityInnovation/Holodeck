...
{
public class GetDefaultEvent_System_Type
{
public static bool _GetDefaultEvent_System_Type( )
{
   ...
   try
   {
      returnVal_Real = _System_ComponentModel_TypeDescriptor.GetDefaultEvent(componentType);
   }
   ...
   try
   {
      returnVal_Intercepted = _System_ComponentModel_TypeDescriptor.GetDefaultEvent(componentType);
   }
