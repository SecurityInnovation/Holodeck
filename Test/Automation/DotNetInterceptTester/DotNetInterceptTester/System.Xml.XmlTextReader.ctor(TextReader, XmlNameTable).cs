...
{
public class ctor_System_Xml_XmlTextReader_System_IO_TextReader_System_Xml_XmlNameTable
{
public static bool _ctor_System_Xml_XmlTextReader_System_IO_TextReader_System_Xml_XmlNameTable( )
{
   //Parameters
