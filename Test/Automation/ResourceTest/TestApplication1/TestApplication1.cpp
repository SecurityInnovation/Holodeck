...
void main (void) {
...

	{
		...
		cout << (tempPath + "\\resources1reg.txt").c_str ();
		outFile = new ofstream ((tempPath + "\\resources1reg.txt").c_str ());
	}
	...
	GetLocalTime (&systemTime);
	/*<Resource>*/res = RegConnectRegistryW (L"", HKEY_CLASSES_ROOT, &rKey0);
	(*outFile) << "Name: " << (machineName != "" ? machineName + "\\\\" : "") << "HKEY_CLASSES_ROOT" << "\n";
	...
	GetLocalTime (&systemTime);
	/*<Resource>*/res = RegConnectRegistryW (L"", HKEY_CURRENT_CONFIG, &rKey0);
	(*outFile) << "Name: " << (machineName != "" ? machineName + "\\\\" : "") << "HKEY_CURRENT_CONFIG" << "\n";
	(*outFile) << "Func: " << "RegConnectRegistryW" << "\n";
	(*outFile) << "Proc: " << _getpid () << "\n";
	(*outFile) << "Time: " << GetTime (systemTime).c_str () << "\n";
	...
	GetLocalTime (&systemTime);
	/*<Resource>*/res = RegConnectRegistryW (L"", HKEY_CURRENT_USER, &rKey0);
	(*outFile) << "Name: " << (machineName != "" ? machineName + "\\\\" : "") << "HKEY_CURRENT_USER" << "\n";
	(*outFile) << "Func: " << "RegConnectRegistryW" << "\n";
	(*outFile) << "Proc: " << _getpid () << "\n";
	(*outFile) << "Time: " << GetTime (systemTime).c_str () << "\n";
	...
	GetLocalTime (&systemTime);
	/*<Resource>*/res = RegConnectRegistryW (L"", HKEY_DYN_DATA, &rKey0);
	(*outFile) << "Name: " << (machineName != "" ? machineName + "\\\\" : "") << "HKEY_DYN_DATA" << "\n";
	(*outFile) << "Func: " << "RegConnectRegistryW" << "\n";
	(*outFile) << "Proc: " << _getpid () << "\n";
	(*outFile) << "Time: " << GetTime (systemTime).c_str () << "\n";
	...
	GetLocalTime (&systemTime);
	/*<Resource>*/res = RegConnectRegistryW (L"", HKEY_LOCAL_MACHINE, &rKey0);
	(*outFile) << "Name: " << (machineName != "" ? machineName + "\\\\" : "") << "HKEY_LOCAL_MACHINE" << "\n";
	(*outFile) << "Func: " << "RegConnectRegistryW" << "\n";
	(*outFile) << "Proc: " << _getpid () << "\n";
	(*outFile) << "Time: " << GetTime (systemTime).c_str () << "\n";
	...
	GetLocalTime (&systemTime);
	/*<Resource>*/res = RegConnectRegistryW (L"", HKEY_PERFORMANCE_DATA, &rKey0);
	(*outFile) << "Name: " << (machineName != "" ? machineName + "\\\\" : "") << "HKEY_PERFORMANCE_DATA" << "\n";
	(*outFile) << "Func: " << "RegConnectRegistryW" << "\n";
	(*outFile) << "Proc: " << _getpid () << "\n";
	(*outFile) << "Time: " << GetTime (systemTime).c_str () << "\n";
	...
	GetLocalTime (&systemTime);
	/*<Resource>*/res = RegConnectRegistryW (L"", HKEY_USERS, &rKey0);
	(*outFile) << "Name: " << (machineName != "" ? machineName + "\\\\" : "") << "HKEY_USERS" << "\n";
	(*outFile) << "Func: " << "RegConnectRegistryW" << "\n";
	(*outFile) << "Proc: " << _getpid () << "\n";
	(*outFile) << "Time: " << GetTime (systemTime).c_str () << "\n";
	...
	GetLocalTime (&systemTime);
	/*<Resource>*/res = RegFlushKey (rKey0);
	(*outFile) << "Name: " << (machineName != "" ? machineName + "\\\\" : "") << "HKEY_LOCAL_MACHINE\\SOFTWARE\\HolodeckEE" << "\n";
	(*outFile) << "Func: " << "RegFlushKey" << "\n";
	(*outFile) << "Proc: " << _getpid () << "\n";
	(*outFile) << "Time: " << GetTime (systemTime).c_str () << "\n";
	(*outFile) << "Retv: " << res << "\n";
	(*outFile) << "Errc: " << GetLastError () << "\n";
	...
	GetLocalTime (&systemTime);
	/*<Resource>*/res = RegOpenCurrentUser (KEY_ALL_ACCESS, &rKey1);
	(*outFile) << "Name: " << (machineName != "" ? machineName + "\\\\" : "") << "HKEY_CURRENT_USER" << "\n";
	(*outFile) << "Func: " << "RegOpenCurrentUser" << "\n";
	(*outFile) << "Proc: " << _getpid () << "\n";
	(*outFile) << "Time: " << GetTime (systemTime).c_str () << "\n";
	(*outFile) << "Retv: " << res << "\n";
	(*outFile) << "Errc: " << GetLastError () << "\n";
	...
	GetLocalTime (&systemTime);
	/*<Resource>*/res = RegOpenKeyW (HKEY_LOCAL_MACHINE, L"SOFTWARE", &rKey1);
	(*outFile) << "Name: " << "HKEY_LOCAL_MACHINE\\SOTWARE" << "\n";
	(*outFile) << "Func: " << "RegOpenKeyW" << "\n";
	(*outFile) << "Proc: " << _getpid () << "\n";
	(*outFile) << "Time: " << GetTime (systemTime).c_str () << "\n";
	(*outFile) << "Retv: " << res << "\n";
	(*outFile) << "Errc: " << GetLastError () << "\n";
	...
	GetLocalTime (&systemTime);
	/*<Resource>*/res = RegOpenKeyExW (HKEY_LOCAL_MACHINE, L"SOFTWARE", 0, KEY_ALL_ACCESS, &rKey1);
	(*outFile) << "Name: " << "HKEY_LOCAL_MACHINE\\SOTWARE" << "\n";
	(*outFile) << "Func: " << "RegOpenKeyExW" << "\n";
	(*outFile) << "Proc: " << _getpid () << "\n";
	(*outFile) << "Time: " << GetTime (systemTime).c_str () << "\n";
	(*outFile) << "Retv: " << res << "\n";
	(*outFile) << "Errc: " << GetLastError () << "\n";
	...
	res = RegOverridePredefKey (HKEY_LOCAL_MACHINE, rKey0);
	keySize = DefSize;

	GetLocalTime (&systemTime);
	/*<Resource>*/res = RegEnumKeyA (HKEY_LOCAL_MACHINE, 0, keyName, keySize);
	(*outFile) << "Name: " << "HKEY_LOCAL_MACHINE\\SOFTWARE\\HolodeckEE\\" << keyName << "\n";
	(*outFile) << "Func: " << "RegEnumKeyA" << "\n";
	(*outFile) << "Proc: " << _getpid () << "\n";
	(*outFile) << "Time: " << GetTime (systemTime).c_str () << "\n";
	(*outFile) << "Retv: " << res << "\n";
	...
	res = RegOverridePredefKey (HKEY_LOCAL_MACHINE, NULL);
	...
	GetLocalTime (&systemTime);
	/*<Resource>*/res = RegQueryValueW (HKEY_LOCAL_MACHINE, L"SOFTWARE", (LPWSTR) data, &dataSize);
	(*outFile) << "Name: " << "HKEY_LOCAL_MACHINE\\SOFTWARE\\" << data << "\n";
	(*outFile) << "Func: " << "RegQueryValueW" << "\n";
	(*outFile) << "Proc: " << _getpid () << "\n";
	(*outFile) << "Time: " << GetTime (systemTime).c_str () << "\n";
	(*outFile) << "Retv: " << res << "\n";
	(*outFile) << "Errc: " << GetLastError () << "\n";
	...
	GetLocalTime (&systemTime);
	/*<Resource>*/res = RegDeleteValue (rKey1, NULL);
	(*outFile) << "Name: " << (machineName != "" ? machineName + "\\\\" : "") << "HKEY_LOCAL_MACHINE\\SOFTWARE\\HolodeckEE\\ResourcePaneTestKey7\\(Default)" << "\n";
	(*outFile) << "Func: " << "RegDeleteValue" << "\n";
	(*outFile) << "Proc: " << _getpid () << "\n";
	(*outFile) << "Time: " << GetTime (systemTime).c_str () << "\n";
