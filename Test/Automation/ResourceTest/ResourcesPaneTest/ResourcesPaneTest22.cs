...
namespace ResourcesPaneTest {        
	/// <summary>
	/// Parent directory traversal ("..") .NET file testing
	/// </summary>
	public class ResourcesPaneTest22 : ResourcesPaneTest {
		protected override string GenerateTestApplication (string testID) {
			// TODO: provide native code generation
			throw new CannotGenerateTestApp ("No implementation for native code yet.");
		}
