...
namespace TestApplication14 {
	...
	class Class1 {
		...
		static void Main(string[] args) {
			...
			string specDirName = "ώдΘžҖשچ€∞╛⅞♪♂אַﺅﻅﻵŊΔ";
			string specFileName = "ώдΘžҖשچ€∞╛⅞♪♂אַﺅﻅﻵŊΔ";
			...
			System.IO.FileInfo fileInfo = new System.IO.FileInfo (tempPath + "\\resources14file.txt");
			fileInfo.Create ().Close ();
			System.IO.StreamWriter outFile = fileInfo.AppendText ();
			System.Console.WriteLine (tempPath + "\\resources14file.txt");
			...
			try {
				...
				xc = System.Security.Cryptography.X509Certificates.X509Certificate.CreateFromCertFile (specFileName);
			} catch (Exception e) {
				exc = e;
			} finally {
				outFile.WriteLine ("Name: " + specFileName);
			...
			try {
				...
				xc = null;
				now = System.DateTime.Now;
				xc = System.Security.Cryptography.X509Certificates.X509Certificate.CreateFromSignedFile (specFileName);
			} catch (Exception e) {
				exc = e;
			} finally {
				outFile.WriteLine ("Name: " + specFileName);
...
*/
			...
			try {
				...
				try {
					...
					sw = null;
					now = System.DateTime.Now;
					sw = new System.IO.StreamWriter (specFileName);
					outFile.WriteLine ("Name: " + specFileName);
				...
				try {
					...
					sr = null;
					now = System.DateTime.Now;
					sr = new System.IO.StreamReader (specFileName);
					outFile.WriteLine ("Name: " + specFileName);
			...
			try {
				try {
					...
					di = null;
					now = System.DateTime.Now;
					di = System.IO.Directory.CreateDirectory (specDirName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + specDirName);
				...
				try {
					...
					di = null;
					now = System.DateTime.Now;
					di = System.IO.Directory.GetParent (specDirName);
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					b = System.IO.Directory.Exists (specDirName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + specDirName);
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.Directory.SetCreationTime (specDirName, new System.DateTime (2003, 01, 01));
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + specDirName);
				...
				try {
					...
					dt = InicDateTime ();
					now = System.DateTime.Now;
					dt = System.IO.Directory.GetCreationTime (specDirName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + specDirName);
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.Directory.SetLastWriteTime (specDirName, new System.DateTime (2003, 01, 01));
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + specDirName);
				...
				try {
					...
					dt = InicDateTime ();
					now = System.DateTime.Now;
					dt = System.IO.Directory.GetLastWriteTime (specDirName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + specDirName);
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.Directory.SetLastAccessTime (specDirName, new System.DateTime (2003, 01, 01));
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + specDirName);
				...
				try {
					...
					dt = InicDateTime ();
					now = System.DateTime.Now;
					dt = System.IO.Directory.GetLastAccessTime (specDirName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + specDirName);
				...
				try {
					...
					sL = null;
					now = System.DateTime.Now;
					sL = System.IO.Directory.GetFiles (specDirName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + specDirName);
				...
				try {
					...
					sL = null;
					now = System.DateTime.Now;
					sL = System.IO.Directory.GetDirectories (specDirName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + specDirName);
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.Directory.GetFileSystemEntries (specDirName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + specDirName);
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.Directory.SetCurrentDirectory (specDirName + "\\..");
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath);
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.Directory.Move (specDirName, tempPath + "\\TestDir2");
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + specDirName);
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.Directory.Delete (specDirName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + specDirName);
			...
			try {
				...
				try {
					try {
						...
						di2 = null;
						now = System.DateTime.Now;
						di2 = di.CreateSubdirectory (specDirName);
						di = di2;
					} catch (Exception e) {
						exc = e;
					} finally {
				...
				try {
					di = null;
					di = new System.IO.DirectoryInfo (specDirName);
					try {
						exc = null;
						now = System.DateTime.Now;
						di.Create ();
			...
			try {
				try {
					...
					sr = null;
					now = System.DateTime.Now;
					sr = System.IO.File.OpenText (specFileName);
					sr.Close ();
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					...
					sw = null;
					now = System.DateTime.Now;
					sw = System.IO.File.CreateText (specFileName);
					sw.Close ();
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					...
					sw = null;
					now = System.DateTime.Now;
					sw = System.IO.File.AppendText (specFileName);
					sw.Close ();
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					...
					fs = null;
					now = System.DateTime.Now;
					fs = System.IO.File.Open (specFileName, System.IO.FileMode.OpenOrCreate);
					fs.Close ();
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.File.SetCreationTime (specFileName, new System.DateTime (2003, 01, 01));
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + specFileName);
				...
				try {
					...
					dt = InicDateTime ();
					now = System.DateTime.Now;
					dt = System.IO.File.GetCreationTime (specFileName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + specFileName);
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.File.SetLastAccessTime (specFileName, new System.DateTime (2003, 01, 01));
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + specFileName);
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					dt = System.IO.File.GetLastAccessTime (specFileName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + specFileName);
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.File.SetLastWriteTime (specFileName, new System.DateTime (2003, 01, 01));
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + specFileName);
				...
				try {
					...
					dt = InicDateTime ();
					now = System.DateTime.Now;
					dt = System.IO.File.GetLastWriteTime (specFileName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + specFileName);
				...
				try {
					...
					fs = null;
					now = System.DateTime.Now;
					fs = System.IO.File.OpenRead (specFileName);
					fs.Close ();
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					...
					fs = null;
					now = System.DateTime.Now;
					fs = System.IO.File.OpenWrite (specFileName);
					fs.Close ();
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					...
					fs = null;
					now = System.DateTime.Now;
					fs = System.IO.File.Create (specFileName);
					fs.Close ();
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					...
					fs = null;
					now = System.DateTime.Now;
					System.IO.File.Move (specFileName, tempPath + "\\testFile2.txt");
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + specFileName);
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					b = System.IO.File.Exists (specFileName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + specFileName);
			...
			try {
				fi = new System.IO.FileInfo (specFileName);
				try {
					exc = null;
					fs = null;
					now = System.DateTime.Now;
			...
			try {
				System.IO.TextWriter tw = new System.IO.StreamWriter (specFileName);
				try {
					exc = null;
					now = System.DateTime.Now;
					tw.WriteLine ("hello");
			...
			try {
				...
				array[0] = 'a';
				System.IO.TextReader tr = new System.IO.StreamReader (specFileName);
				try {
					exc = null;
					s = null;
					now = System.DateTime.Now;
...
*/
			...
			try {
				...
				isfs = null;
				now = System.DateTime.Now;
				isfs = new System.IO.IsolatedStorage.IsolatedStorageFileStream (specFileName, System.IO.FileMode.OpenOrCreate);
				outFile.WriteLine ("Name: " + specFileName);
			...
			try {
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					wc.DownloadFile ("http://www.google.com", specFileName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + specFileName);
				...
				try {
					...
					bL = null;
					now = System.DateTime.Now;
					bL = wc.UploadFile ("http://www.google.com", specFileName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + specFileName);
			...
			try {
				...
				try {
					...
					p = null;
					now = System.DateTime.Now;
					p = System.Diagnostics.Process.Start (specFileName);
				...
				try {
					exc = null;
					System.Diagnostics.ProcessStartInfo psi = new System.Diagnostics.ProcessStartInfo (specFileName);
					p = null;
					now = System.DateTime.Now;
