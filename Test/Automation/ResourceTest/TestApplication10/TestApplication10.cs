...
namespace TestApplication10 {
	...
	class Class1 {
		...
		private static string CreateLongString (string tempDir, string machineName, bool dirName) {
			string path = "";
			long pathLen = 1;
			long maxPathLen = 255 - 5;
		...
		private static string CreateLongString2 (string tempDir, string machineName, bool dirName) {
			string path = "";
			long pathLen = 1;
			long maxPathLen = 255 - 5;
			string[] chars = {"1", "2", "3", "4", "5", "6", "7", "8", "9", "0"};
		...
		static void Main(string[] args) {
			...
			string longDirName = CreateLongString (tempPath, "", true);
			string longFileName = CreateLongString (tempPath, "", false);
			string longDirName2 = CreateLongString2 (tempPath, "", true);
			string longFileName2 = CreateLongString2 (tempPath, "", false);
			...
			System.IO.FileInfo fileInfo = new System.IO.FileInfo (tempPath + "\\resources10file.txt");
			fileInfo.Create ().Close ();
			System.IO.StreamWriter outFile = fileInfo.AppendText ();
			System.Console.WriteLine (tempPath + "\\resources10file.txt");
			...
			try {
				...
				xc = System.Security.Cryptography.X509Certificates.X509Certificate.CreateFromCertFile (longFileName);
			} catch (Exception e) {
				exc = e;
			} finally {
				outFile.WriteLine ("Name: " + tempPath + "\\" + longFileName2);
			...
			try {
				...
				xc = null;
				now = System.DateTime.Now;
				xc = System.Security.Cryptography.X509Certificates.X509Certificate.CreateFromSignedFile (longFileName);
			} catch (Exception e) {
				exc = e;
			} finally {
				outFile.WriteLine ("Name: " + tempPath + "\\" + longFileName2);
...
*/
			try {
				...
				try {
					...
					sw = null;
					now = System.DateTime.Now;
					sw = new System.IO.StreamWriter (longFileName);
					outFile.WriteLine ("Name: " + tempPath + "\\" + longFileName2);
				...
				try {
					...
					sr = null;
					now = System.DateTime.Now;
					sr = new System.IO.StreamReader (tempPath + "\\" + longFileName2);
					outFile.WriteLine ("Name: " + tempPath + "\\" + longFileName2);
			...
			try {
				try {
					...
					di = null;
					now = System.DateTime.Now;
					di = System.IO.Directory.CreateDirectory (longDirName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\" + longDirName2);
				...
				try {
					...
					di = null;
					now = System.DateTime.Now;
					di = System.IO.Directory.GetParent (longDirName);
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					b = System.IO.Directory.Exists (longDirName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\" + longDirName2);
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.Directory.SetCreationTime (longDirName, new System.DateTime (2003, 01, 01));
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\" + longDirName2);
				...
				try {
					...
					dt = InicDateTime ();
					now = System.DateTime.Now;
					dt = System.IO.Directory.GetCreationTime (longDirName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\" + longDirName2);
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.Directory.SetLastWriteTime (longDirName, new System.DateTime (2003, 01, 01));
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\" + longDirName2);
				...
				try {
					...
					dt = InicDateTime ();
					now = System.DateTime.Now;
					dt = System.IO.Directory.GetLastWriteTime (longDirName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\" + longDirName2);
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.Directory.SetLastAccessTime (longDirName, new System.DateTime (2003, 01, 01));
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\" + longDirName2);
				...
				try {
					...
					dt = InicDateTime ();
					now = System.DateTime.Now;
					dt = System.IO.Directory.GetLastAccessTime (longDirName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\" + longDirName2);
				...
				try {
					...
					sL = null;
					now = System.DateTime.Now;
					sL = System.IO.Directory.GetFiles (longDirName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\" + longDirName2);
				...
				try {
					...
					sL = null;
					now = System.DateTime.Now;
					sL = System.IO.Directory.GetDirectories (longDirName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\" + longDirName2);
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.Directory.GetFileSystemEntries (longDirName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\" + longDirName2);
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.Directory.SetCurrentDirectory (longDirName + "\\..");
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath);
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.Directory.Move (longDirName, tempPath + "\\TestDir2");
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\" + longDirName2);
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.Directory.Delete (longDirName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\" + longDirName2);
			...
			try {
				...
				try {
					try {
						...
						di2 = null;
						now = System.DateTime.Now;
						di2 = di.CreateSubdirectory (longDirName);
						di = di2;
					} catch (Exception e) {
						exc = e;
					} finally {
				...
				try {
					di = null;
					di = new System.IO.DirectoryInfo (longDirName);
					try {
						exc = null;
						now = System.DateTime.Now;
						di.Create ();
			...
			try {
				try {
					...
					sr = null;
					now = System.DateTime.Now;
					sr = System.IO.File.OpenText (longFileName);
					sr.Close ();
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					...
					sw = null;
					now = System.DateTime.Now;
					sw = System.IO.File.CreateText (longFileName);
					sw.Close ();
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					...
					sw = null;
					now = System.DateTime.Now;
					sw = System.IO.File.AppendText (longFileName);
					sw.Close ();
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					...
					fs = null;
					now = System.DateTime.Now;
					fs = System.IO.File.Open (longFileName, System.IO.FileMode.OpenOrCreate);
					fs.Close ();
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.File.SetCreationTime (longFileName, new System.DateTime (2003, 01, 01));
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\" + longFileName2);
				...
				try {
					...
					dt = InicDateTime ();
					now = System.DateTime.Now;
					dt = System.IO.File.GetCreationTime (longFileName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\" + longFileName2);
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.File.SetLastAccessTime (longFileName, new System.DateTime (2003, 01, 01));
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\" + longFileName2);
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					dt = System.IO.File.GetLastAccessTime (longFileName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\" + longFileName2);
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.File.SetLastWriteTime (longFileName, new System.DateTime (2003, 01, 01));
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\" + longFileName2);
				...
				try {
					...
					dt = InicDateTime ();
					now = System.DateTime.Now;
					dt = System.IO.File.GetLastWriteTime (longFileName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\" + longFileName2);
				...
				try {
					...
					fs = null;
					now = System.DateTime.Now;
					fs = System.IO.File.OpenRead (longFileName);
					fs.Close ();
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					...
					fs = null;
					now = System.DateTime.Now;
					fs = System.IO.File.OpenWrite (longFileName);
					fs.Close ();
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					...
					fs = null;
					now = System.DateTime.Now;
					fs = System.IO.File.Create (longFileName);
					fs.Close ();
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					...
					fs = null;
					now = System.DateTime.Now;
					System.IO.File.Move (longFileName, tempPath + "\\testFile2.txt");
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\" + longFileName2);
					outFile.WriteLine ("Func: " + "System.IO.File.Move(String, String)");
					outFile.WriteLine ("Proc: " + System.Diagnostics.Process.GetCurrentProcess ().Id);
					outFile.WriteLine ("Time: " + GetTime (now));
					outFile.WriteLine ("Retv: " + "");
					outFile.WriteLine ("Errc: " + "");
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					b = System.IO.File.Exists (longFileName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\" + longFileName2);
			...
			try {
				fi = new System.IO.FileInfo (longFileName);
				try {
					exc = null;
					fs = null;
					now = System.DateTime.Now;
			...
			try {
				System.IO.TextWriter tw = new System.IO.StreamWriter (longFileName);
				try {
					exc = null;
					now = System.DateTime.Now;
					tw.WriteLine ("hello");
			...
			try {
				...
				array[0] = 'a';
				System.IO.TextReader tr = new System.IO.StreamReader (longFileName);
				try {
					exc = null;
					s = null;
					now = System.DateTime.Now;
...
*/
			try {
				...
				isfs = null;
				now = System.DateTime.Now;
				isfs = new System.IO.IsolatedStorage.IsolatedStorageFileStream (longFileName, System.IO.FileMode.OpenOrCreate);
				outFile.WriteLine ("Name: " + tempPath + "\\" + longFileName2);
			...
			try {
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					wc.DownloadFile ("http://www.google.com", longFileName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\" + longFileName2);
				...
				try {
					...
					bL = null;
					now = System.DateTime.Now;
					bL = wc.UploadFile ("http://www.google.com", longFileName);
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\" + longFileName2);
			...
			try {
				...
				try {
					...
					p = null;
					now = System.DateTime.Now;
					p = System.Diagnostics.Process.Start (longFileName);
				...
				try {
					exc = null;
					System.Diagnostics.ProcessStartInfo psi = new System.Diagnostics.ProcessStartInfo (longFileName);
					p = null;
					now = System.DateTime.Now;
...
*/
			...
			try {
				sL = System.IO.Directory.GetFiles (tempPath, "12345*.*");
				...
				sL = System.IO.Directory.GetDirectories (tempPath, "12345*.*");
				foreach (string str in sL) {
					try {
