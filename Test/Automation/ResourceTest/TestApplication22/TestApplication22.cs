...
namespace TestApplication22 {
	...
	class Class1 {
		...
		static void Main(string[] args) {
			...
			string baseTemp = (new System.IO.DirectoryInfo (tempPath)).Name;
			...
			System.IO.FileInfo fileInfo = new System.IO.FileInfo (tempPath + "\\resources22file.txt");
			fileInfo.Create ().Close ();
			System.IO.StreamWriter outFile = fileInfo.AppendText ();
			System.Console.WriteLine (tempPath + "\\resources22file.txt");
			...
			try {
				...
				xc = System.Security.Cryptography.X509Certificates.X509Certificate.CreateFromCertFile (tempPath + "\\..\\" + baseTemp + "\\dummyFile1.txt");
			} catch (Exception e) {
				exc = e;
			} finally {
			...
			try {
				...
				xc = null;
				now = System.DateTime.Now;
				xc = System.Security.Cryptography.X509Certificates.X509Certificate.CreateFromSignedFile (tempPath + "\\..\\" + baseTemp + "\\dummyFile2.txt");
			} catch (Exception e) {
				exc = e;
			} finally {
...
*/
			try {
				...
				try {
					...
					sw = null;
					now = System.DateTime.Now;
					sw = new System.IO.StreamWriter (tempPath + "\\..\\" + baseTemp + "\\dummyFile3.txt");
				...
				try {
					...
					sr = null;
					now = System.DateTime.Now;
					sr = new System.IO.StreamReader (tempPath + "\\..\\" + baseTemp + "\\dummyFile4.txt");
				...
				try {
					...
					sw = null;
					now = System.DateTime.Now;
					sw = new System.IO.StreamWriter (tempPath + "\\..\\" + baseTemp + "\\dummyFile5.txt");
			...
			try {
				try {
					...
					di = null;
					now = System.DateTime.Now;
					di = System.IO.Directory.CreateDirectory (tempPath + "\\..\\" + baseTemp + "\\TestDir1");
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					...
					di = null;
					now = System.DateTime.Now;
					di = System.IO.Directory.GetParent (tempPath + "\\..\\" + baseTemp + "\\TestDir1");
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					b = System.IO.Directory.Exists (tempPath + "\\..\\" + baseTemp + "\\TestDir1");
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\TestDir1");
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.Directory.SetCreationTime (tempPath + "\\..\\" + baseTemp + "\\TestDir1", new System.DateTime (2003, 01, 01));
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\TestDir1");
				...
				try {
					...
					dt = InicDateTime ();
					now = System.DateTime.Now;
					dt = System.IO.Directory.GetCreationTime (tempPath + "\\..\\" + baseTemp + "\\TestDir1");
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\TestDir1");
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.Directory.SetLastWriteTime (tempPath + "\\..\\" + baseTemp + "\\TestDir1", new System.DateTime (2003, 01, 01));
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\TestDir1");
				...
				try {
					...
					dt = InicDateTime ();
					now = System.DateTime.Now;
					dt = System.IO.Directory.GetLastWriteTime (tempPath + "\\..\\" + baseTemp + "\\TestDir1");
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\TestDir1");
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.Directory.SetLastAccessTime (tempPath + "\\..\\" + baseTemp + "\\TestDir1", new System.DateTime (2003, 01, 01));
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\TestDir1");
				...
				try {
					...
					dt = InicDateTime ();
					now = System.DateTime.Now;
					dt = System.IO.Directory.GetLastAccessTime (tempPath + "\\..\\" + baseTemp + "\\TestDir1");
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\TestDir1");
				...
				try {
					...
					sL = null;
					now = System.DateTime.Now;
					sL = System.IO.Directory.GetFiles (tempPath + "\\..\\" + baseTemp + "\\TestDir1");
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\TestDir1");
				...
				try {
					...
					sL = null;
					now = System.DateTime.Now;
					sL = System.IO.Directory.GetDirectories (tempPath + "\\..\\" + baseTemp + "\\TestDir1");
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\TestDir1");
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.Directory.GetFileSystemEntries (tempPath + "\\..\\" + baseTemp + "\\TestDir1");
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\TestDir1");
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.Directory.SetCurrentDirectory (tempPath + "\\..\\" + baseTemp + "\\TestDir1\\..");
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath);
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.Directory.Move (tempPath + "\\..\\" + baseTemp + "\\TestDir1", tempPath + "\\..\\" + baseTemp + "\\TestDir2");
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\TestDir1");
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.Directory.Delete (tempPath + "\\..\\" + baseTemp + "\\TestDir1");
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\TestDir1");
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.Directory.Delete (tempPath + "\\..\\" + baseTemp + "\\TestDir2");
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\TestDir2");
			...
			try {
				...
				try {
					try {
						...
						di2 = null;
						now = System.DateTime.Now;
						di2 = di.CreateSubdirectory (tempPath + "\\..\\" + baseTemp + "\\TestDir3");
						di = di2;
					} catch (Exception e) {
						exc = e;
					} finally {
					...
					try {
						exc = null;
						now = System.DateTime.Now;
						di.MoveTo (tempPath + "\\..\\" + baseTemp + "\\TestDir4");
					} catch (Exception e) {
						exc = e;
					} finally {
						outFile.WriteLine ("Name: " + tempPath + "\\TestDir3");
				...
				try {
					di = null;
					di = new System.IO.DirectoryInfo (tempPath + "\\..\\" + baseTemp + "\\TestDir5");
					try {
						exc = null;
						now = System.DateTime.Now;
						di.Create ();
					...
					try {
						exc = null;
						now = System.DateTime.Now;
						di.MoveTo (tempPath + "\\..\\" + baseTemp + "\\TestDir6");
					} catch (Exception e) {
						exc = e;
					} finally {
						outFile.WriteLine ("Name: " + tempPath + "\\TestDir5");
			...
			try {
				try {
					...
					sr = null;
					now = System.DateTime.Now;
					sr = System.IO.File.OpenText (tempPath + "\\..\\" + baseTemp + "\\dummyFile6.txt");
					sr.Close ();
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					...
					sw = null;
					now = System.DateTime.Now;
					sw = System.IO.File.CreateText (tempPath + "\\..\\" + baseTemp + "\\dummyFile7.txt");
					sw.Close ();
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					...
					sw = null;
					now = System.DateTime.Now;
					sw = System.IO.File.AppendText (tempPath + "\\..\\" + baseTemp + "\\dummyFile8.txt");
					sw.Close ();
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					...
					fs = null;
					now = System.DateTime.Now;
					fs = System.IO.File.Open (tempPath + "\\..\\" + baseTemp + "\\dummyFile9.txt", System.IO.FileMode.OpenOrCreate);
					fs.Close ();
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.File.SetCreationTime (tempPath + "\\..\\" + baseTemp + "\\dummyFile9.txt", new System.DateTime (2003, 01, 01));
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\dummyFile9.txt");
				...
				try {
					...
					dt = InicDateTime ();
					now = System.DateTime.Now;
					dt = System.IO.File.GetCreationTime (tempPath + "\\..\\" + baseTemp + "\\dummyFile9.txt");
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\dummyFile9.txt");
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.File.SetLastAccessTime (tempPath + "\\..\\" + baseTemp + "\\dummyFile9.txt", new System.DateTime (2003, 01, 01));
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\dummyFile9.txt");
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					dt = System.IO.File.GetLastAccessTime (tempPath + "\\..\\" + baseTemp + "\\dummyFile9.txt");
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\dummyFile9.txt");
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.File.SetLastWriteTime (tempPath + "\\..\\" + baseTemp + "\\dummyFile9.txt", new System.DateTime (2003, 01, 01));
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\dummyFile9.txt");
				...
				try {
					...
					dt = InicDateTime ();
					now = System.DateTime.Now;
					dt = System.IO.File.GetLastWriteTime (tempPath + "\\..\\" + baseTemp + "\\dummyFile9.txt");
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\dummyFile9.txt");
				...
				try {
					...
					fs = null;
					now = System.DateTime.Now;
					fs = System.IO.File.OpenRead (tempPath + "\\..\\" + baseTemp + "\\dummyFile10.txt");
					fs.Close ();
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					...
					fs = null;
					now = System.DateTime.Now;
					fs = System.IO.File.OpenWrite (tempPath + "\\..\\" + baseTemp + "\\dummyFile11.txt");
					fs.Close ();
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					...
					fs = null;
					now = System.DateTime.Now;
					fs = System.IO.File.Create (tempPath + "\\..\\" + baseTemp + "\\testFile1.txt");
					fs.Close ();
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					...
					fs = null;
					now = System.DateTime.Now;
					System.IO.File.Move (tempPath + "\\..\\" + baseTemp + "\\testFile1.txt", tempPath + "\\..\\" + baseTemp + "\\testFile2.txt");
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\testFile1.txt");
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					System.IO.File.Delete (tempPath + "\\..\\" + baseTemp + "\\testFile2.txt");
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\testFile2.txt");
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					b = System.IO.File.Exists (tempPath + "\\..\\" + baseTemp + "\\testFile3.txt");
				} catch (Exception e) {
					exc = e;
				} finally {
			...
			try {
				fi = new System.IO.FileInfo (tempPath + "\\..\\" + baseTemp + "\\testFile4.txt");
				try {
					exc = null;
					fs = null;
					now = System.DateTime.Now;
				...
				try {
					exc = null;
					fs = null;
					fi = new System.IO.FileInfo (tempPath + "\\..\\" + baseTemp + "\\testFile5.txt");
					now = System.DateTime.Now;
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					fi.MoveTo (tempPath + "\\..\\" + baseTemp + "\\testFile6.txt");
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\testFile5.txt");
			...
			try {
				...
				fs = null;
				now = System.DateTime.Now;
				fs = System.IO.File.Open (tempPath + "\\..\\" + baseTemp + "\\dummyFile12.txt", System.IO.FileMode.OpenOrCreate);
			...
			try {
				System.IO.TextWriter tw = new System.IO.StreamWriter (tempPath + "\\..\\" + baseTemp + "\\dummyFile13.txt");
				try {
					exc = null;
					now = System.DateTime.Now;
					tw.WriteLine ("hello");
			...
			try {
				...
				array[0] = 'a';
				System.IO.TextReader tr = new System.IO.StreamReader (tempPath + "\\..\\" + baseTemp + "\\dummyFile13.txt");
				try {
					exc = null;
					s = null;
					now = System.DateTime.Now;
			...
			try {
				sw = new System.IO.StreamWriter (tempPath + "\\..\\" + baseTemp + "\\dummyFile14.txt");
				try {
					exc = null;
					now = System.DateTime.Now;
					sw.Write (0);
...
*/
			try {
				...
				isfs = null;
				now = System.DateTime.Now;
				isfs = new System.IO.IsolatedStorage.IsolatedStorageFileStream (tempPath + "\\..\\" + baseTemp + "\\dummyFile15.txt", System.IO.FileMode.OpenOrCreate);
			...
			try {
				...
				try {
					exc = null;
					now = System.DateTime.Now;
					wc.DownloadFile ("http://www.google.com", tempPath + "\\..\\" + baseTemp + "\\dummyFile16.txt");
				} catch (Exception e) {
					exc = e;
				} finally {
				...
				try {
					...
					bL = null;
					now = System.DateTime.Now;
					bL = wc.UploadFile ("http://www.google.com", tempPath + "\\..\\" + baseTemp + "\\dummyFile16.txt");
				} catch (Exception e) {
					exc = e;
				} finally {
					outFile.WriteLine ("Name: " + tempPath + "\\dummyFile16.txt");
			...
			try {
				...
				try {
					...
					p = null;
					now = System.DateTime.Now;
					p = System.Diagnostics.Process.Start (tempPath + "\\..\\" + baseTemp + "\\dummyFile16.txt");
				...
				try {
					exc = null;
					System.Diagnostics.ProcessStartInfo psi = new System.Diagnostics.ProcessStartInfo (tempPath + "\\..\\" + baseTemp + "\\dummyFile16.txt");
					p = null;
					now = System.DateTime.Now;
