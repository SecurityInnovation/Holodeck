...
namespace TestingFunctionXML
{
	...
	{
		public Hashtable FunctionTableByName;
			...
			while (hasMoreFunctionElements)
			{
				...
				switch (functionNavigator.Name)
				{
					case "FunctionName":
					{
						...
						FunctionList.Add((string)(functionNavigator.Value));
						break;
					}
					...
					case "CallingConventionModifier": 
					{
						function.CallingConventionModifier.Add(functionNavigator.Value);
						break;
					}
					case "Category":
					{
		...
		protected ReturnValue ParseReturnValue(XPathNavigator childNavigator)
		{
			...
			returnValue.ValueOperator = null;
			...
			while (hasMoreAttributes)
			{
				...
				if (ecNavigator.Name.CompareTo("ValueOperator") == 0)
				{
					returnValue.ValueOperator = ecNavigator.Value;
				}
		...
		protected Parameter ParseParameter(XPathNavigator childNavigator)
		{
			...
			while (hasMoreAttributes)
			{
				switch(paramNavigator.Name)
				{
					...
					case "ConcatWith":
					{
						parameter.ConcatWith = paramNavigator.Value;
						break;
					}
					case "PointsToResource":
					{
						parameter.PointsToResource = paramNavigator.Value;
						break;
					}
					case "MapTo":
					{
