...
namespace TestingFunctionXML
{
	...
	public class Function
	{
		...
		public Function()
		{
			...
			callingConventionModifier = new ArrayList();
		...
		protected ArrayList callingConventionModifier;
		...
		public ArrayList CallingConventionModifier
		{
			get
			{
				return this.callingConventionModifier;
			}
			set
			{
				this.callingConventionModifier.Add(value);
			}
		}
